...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202005ic202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202005ic202005")) {
    check(paused == false) {
