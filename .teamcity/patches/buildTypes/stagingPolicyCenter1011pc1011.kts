...
To apply the patch, change the buildType with id = 'stagingPolicyCenter1011pc1011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenter1011pc1011")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/pc/10.x/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras/ReleaseNotes-files/pc/10.x --delete
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to S3"
