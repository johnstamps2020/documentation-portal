...
To apply the patch, change the buildType with id = '1ce7e5453884d154915a4276b87fc550'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("1ce7e5453884d154915a4276b87fc550")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/pc/202209/config --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="ispc202209config"
