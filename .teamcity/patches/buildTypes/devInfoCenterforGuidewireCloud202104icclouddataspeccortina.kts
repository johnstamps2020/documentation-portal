...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202104icclouddataspeccortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202104icclouddataspeccortina")) {
    params {
        expect {
