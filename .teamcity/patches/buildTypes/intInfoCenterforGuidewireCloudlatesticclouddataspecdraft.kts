...
To apply the patch, change the buildType with id = 'intInfoCenterforGuidewireCloudlatesticclouddataspecdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInfoCenterforGuidewireCloudlatesticclouddataspecdraft")) {
    check(paused == false) {
