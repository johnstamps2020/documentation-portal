...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xExternalAudiencelatestin20211xrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xExternalAudiencelatestin20211xrndraft")) {
    check(paused == false) {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/ReleaseNotes/2021.1.x/ChangedFiles
                cp -R ./${'$'}RESOURCE_DIR/ChangedFiles/2021.1/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/ReleaseNotes/2021.1.x/ChangedFiles/
            """.trimIndent()
        }
    }
    steps {
