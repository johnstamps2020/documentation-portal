...
To apply the patch, change the buildType with id = 'intDataHubforGuidewireCloudlatestdhcloudinstalldraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDataHubforGuidewireCloudlatestdhcloudinstalldraft")) {
    params {
        expect {
