...
To apply the patch, change the buildType with id = 'prodisbc202011appBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011appBillingCenterforGuidewireCloud")) {
    params {
        expect {
