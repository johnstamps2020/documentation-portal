...
To apply the patch, change the buildType with id = 'stagingCustomerEngageAccountManagement1120dxceam1120onpremstaging'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCustomerEngageAccountManagement1120dxceam1120onpremstaging")) {
    params {
        expect {
