...
To apply the patch, change the buildType with id = 'stagingClaimCenterforGuidewireCloud202011cc202011apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingClaimCenterforGuidewireCloud202011cc202011apiref")) {
    check(paused == false) {
