...
To apply the patch, change the buildType with id = 'proddx202104ceclaimsrelnotesCustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceclaimsrelnotesCustomerEngageAccountManagementforClaimCenter")) {
    params {
        expect {
