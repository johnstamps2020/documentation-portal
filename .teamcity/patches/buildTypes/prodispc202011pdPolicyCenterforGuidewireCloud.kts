...
To apply the patch, change the buildType with id = 'prodispc202011pdPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011pdPolicyCenterforGuidewireCloud")) {
    params {
        expect {
