...
To apply the patch, change the buildType with id = 'devBillingCenterforGuidewireCloud202104isbc202104releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenterforGuidewireCloud202104isbc202104releasenotes")) {
    check(paused == false) {
