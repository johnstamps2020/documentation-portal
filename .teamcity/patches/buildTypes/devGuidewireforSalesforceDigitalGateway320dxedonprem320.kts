...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceDigitalGateway320dxedonprem320'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceDigitalGateway320dxedonprem320")) {
    params {
        expect {
