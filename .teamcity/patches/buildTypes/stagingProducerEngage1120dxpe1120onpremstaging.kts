...
To apply the patch, change the buildType with id = 'stagingProducerEngage1120dxpe1120onpremstaging'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingProducerEngage1120dxpe1120onpremstaging")) {
    params {
        expect {
