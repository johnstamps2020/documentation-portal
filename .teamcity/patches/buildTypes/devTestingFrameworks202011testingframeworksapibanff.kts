...
To apply the patch, change the buildType with id = 'devTestingFrameworks202011testingframeworksapibanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devTestingFrameworks202011testingframeworksapibanff")) {
    check(paused == false) {
