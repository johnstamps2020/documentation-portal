...
To apply the patch, change the buildType with id = 'prodselfmanagedpcupgradeguide1011PolicyCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedpcupgradeguide1011PolicyCenter")) {
    check(paused == false) {
