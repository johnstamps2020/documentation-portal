...
To apply the patch, change the buildType with id = 'prodiscc202011newandchangedClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011newandchangedClaimCenterforGuidewireCloud")) {
    params {
        expect {
