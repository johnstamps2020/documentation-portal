...
To apply the patch, change the buildType with id = 'prodispc202011newandchangedPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011newandchangedPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
