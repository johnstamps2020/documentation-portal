...
To apply the patch, change the buildType with id = 'proddxpeclaims1130ProducerEngageforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxpeclaims1130ProducerEngageforClaimCenter")) {
    params {
        expect {
