...
To apply the patch, change the buildType with id = 'intInfoCenterforGuidewireCloudlatesticclouddevrefdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInfoCenterforGuidewireCloudlatesticclouddevrefdraft")) {
    check(paused == false) {
