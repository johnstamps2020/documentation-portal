...
To apply the patch, change the buildType with id = 'devCustomerEngageAccountManagement1130dxceam1130'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCustomerEngageAccountManagement1130dxceam1130")) {
    params {
        expect {
