...
To apply the patch, change the buildType with id = 'stagingProducerEngageforClaimCenter202011dxpeclaims202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingProducerEngageforClaimCenter202011dxpeclaims202011")) {
    check(paused == false) {
