...
To apply the patch, change the buildType with id = 'devBillingCenter909selfmanagedbcupgradetools1450'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenter909selfmanagedbcupgradetools1450")) {
    check(paused == false) {
