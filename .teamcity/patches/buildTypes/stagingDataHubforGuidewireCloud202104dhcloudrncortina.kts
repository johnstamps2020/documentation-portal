...
To apply the patch, change the buildType with id = 'stagingDataHubforGuidewireCloud202104dhcloudrncortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDataHubforGuidewireCloud202104dhcloudrncortina")) {
    params {
        expect {
