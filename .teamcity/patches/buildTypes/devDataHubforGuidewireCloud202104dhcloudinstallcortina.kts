...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202104dhcloudinstallcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202104dhcloudinstallcortina")) {
    params {
        expect {
