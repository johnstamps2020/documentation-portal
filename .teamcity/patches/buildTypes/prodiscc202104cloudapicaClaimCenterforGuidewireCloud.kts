...
To apply the patch, change the buildType with id = 'prodiscc202104cloudapicaClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104cloudapicaClaimCenterforGuidewireCloud")) {
    params {
        expect {
