...
To apply the patch, change the buildType with id = 'intDataHubforGuidewireCloudlatestdhcloudproductdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDataHubforGuidewireCloudlatestdhcloudproductdraft")) {
    params {
        expect {
