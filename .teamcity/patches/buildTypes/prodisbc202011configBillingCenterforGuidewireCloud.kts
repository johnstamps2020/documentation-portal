...
To apply the patch, change the buildType with id = 'prodisbc202011configBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011configBillingCenterforGuidewireCloud")) {
    check(paused == false) {
