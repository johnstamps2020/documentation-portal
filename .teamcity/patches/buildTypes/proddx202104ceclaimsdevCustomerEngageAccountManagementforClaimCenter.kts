...
To apply the patch, change the buildType with id = 'proddx202104ceclaimsdevCustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceclaimsdevCustomerEngageAccountManagementforClaimCenter")) {
    check(paused == false) {
