...
To apply the patch, change the buildType with id = 'intGuidewireforSalesforceViewonDemand11xselfmanageddxvodxqjomllcj'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireforSalesforceViewonDemand11xselfmanageddxvodxqjomllcj")) {
    params {
        expect {
