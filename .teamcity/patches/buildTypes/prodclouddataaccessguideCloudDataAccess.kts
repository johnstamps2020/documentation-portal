...
To apply the patch, change the buildType with id = 'prodclouddataaccessguideCloudDataAccess'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodclouddataaccessguideCloudDataAccess")) {
    params {
        expect {
