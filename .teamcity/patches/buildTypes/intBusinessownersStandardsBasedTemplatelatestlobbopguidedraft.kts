...
To apply the patch, change the buildType with id = 'intBusinessownersStandardsBasedTemplatelatestlobbopguidedraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBusinessownersStandardsBasedTemplatelatestlobbopguidedraft")) {
    params {
        expect {
