...
To apply the patch, change the buildType with id = '1093235c7377a96e337d81ead5743095'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("1093235c7377a96e337d81ead5743095")) {
    check(paused == false) {
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/pc/202209/dataarchiving --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="ispc202209dataarchiving"
