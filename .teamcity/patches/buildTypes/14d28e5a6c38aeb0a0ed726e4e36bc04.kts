...
To apply the patch, change the buildType with id = '14d28e5a6c38aeb0a0ed726e4e36bc04'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("14d28e5a6c38aeb0a0ed726e4e36bc04")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/pc/202209/cloudapica --delete
            """.trimIndent()
