...
To apply the patch, change the buildType with id = 'prodisbc202104rulesBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104rulesBillingCenterforGuidewireCloud")) {
    params {
        expect {
