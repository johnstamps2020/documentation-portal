...
To apply the patch, change the buildType with id = 'prodtestingframeworksapibanffClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksapibanffClaimCenterforGuidewireCloud")) {
    params {
        expect {
