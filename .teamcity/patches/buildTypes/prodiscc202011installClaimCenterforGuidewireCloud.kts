...
To apply the patch, change the buildType with id = 'prodiscc202011installClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011installClaimCenterforGuidewireCloud")) {
    params {
        expect {
