...
To apply the patch, change the buildType with id = 'proddhcloudupgradecortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhcloudupgradecortinaDataHubforGuidewireCloud")) {
    check(paused == false) {
