...
To apply the patch, change the buildType with id = 'stagingClaimCenter1011selfmanagedccupgradeguide1011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingClaimCenter1011selfmanagedccupgradeguide1011")) {
    check(paused == false) {
