...
To apply the patch, change the buildType with id = 'prodispc202104configPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104configPolicyCenterforGuidewireCloud")) {
    params {
        expect {
