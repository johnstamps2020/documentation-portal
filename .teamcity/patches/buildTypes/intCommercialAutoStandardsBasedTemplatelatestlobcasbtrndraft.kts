...
To apply the patch, change the buildType with id = 'intCommercialAutoStandardsBasedTemplatelatestlobcasbtrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCommercialAutoStandardsBasedTemplatelatestlobcasbtrndraft")) {
    check(paused == false) {
