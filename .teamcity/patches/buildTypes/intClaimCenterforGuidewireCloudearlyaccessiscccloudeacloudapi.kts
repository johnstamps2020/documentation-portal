...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudearlyaccessiscccloudeacloudapi'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudearlyaccessiscccloudeacloudapi")) {
    params {
        expect {
