...
To apply the patch, change the buildType with id = 'prodselfmanagedccupgradetools1450ClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedccupgradetools1450ClaimCenter")) {
    params {
        expect {
