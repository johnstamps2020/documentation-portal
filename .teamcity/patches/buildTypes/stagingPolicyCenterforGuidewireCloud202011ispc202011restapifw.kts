...
To apply the patch, change the buildType with id = 'stagingPolicyCenterforGuidewireCloud202011ispc202011restapifw'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenterforGuidewireCloud202011ispc202011restapifw")) {
    check(paused == false) {
