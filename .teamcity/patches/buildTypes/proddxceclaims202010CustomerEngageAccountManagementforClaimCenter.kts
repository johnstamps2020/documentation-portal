...
To apply the patch, change the buildType with id = 'proddxceclaims202010CustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceclaims202010CustomerEngageAccountManagementforClaimCenter")) {
    check(paused == false) {
