...
To apply the patch, change the buildType with id = 'stagingPolicyCenter1010pc1010staging'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenter1010pc1010staging")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/pc/10.x/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/releasenotes/ReleaseNotes-files/pc/10.x --delete
            """.trimIndent()
        }
    }
    steps {
