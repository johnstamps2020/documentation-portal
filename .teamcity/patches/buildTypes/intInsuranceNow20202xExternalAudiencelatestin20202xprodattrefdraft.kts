...
To apply the patch, change the buildType with id = 'intInsuranceNow20202xExternalAudiencelatestin20202xprodattrefdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20202xExternalAudiencelatestin20202xprodattrefdraft")) {
    params {
        expect {
