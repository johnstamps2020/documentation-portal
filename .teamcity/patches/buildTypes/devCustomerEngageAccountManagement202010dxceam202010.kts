...
To apply the patch, change the buildType with id = 'devCustomerEngageAccountManagement202010dxceam202010'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCustomerEngageAccountManagement202010dxceam202010")) {
    check(paused == false) {
