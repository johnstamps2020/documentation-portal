...
To apply the patch, change the buildType with id = 'prodispc202011restapifwPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011restapifwPolicyCenterforGuidewireCloud")) {
    params {
        expect {
