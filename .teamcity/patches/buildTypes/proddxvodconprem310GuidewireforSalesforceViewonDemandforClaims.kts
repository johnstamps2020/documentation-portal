...
To apply the patch, change the buildType with id = 'proddxvodconprem310GuidewireforSalesforceViewonDemandforClaims'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodconprem310GuidewireforSalesforceViewonDemandforClaims")) {
    check(paused == false) {
