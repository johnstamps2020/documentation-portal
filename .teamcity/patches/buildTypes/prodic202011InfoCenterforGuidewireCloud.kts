...
To apply the patch, change the buildType with id = 'prodic202011InfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodic202011InfoCenterforGuidewireCloud")) {
    params {
        expect {
