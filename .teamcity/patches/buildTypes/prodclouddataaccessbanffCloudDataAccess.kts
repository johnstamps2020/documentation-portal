...
To apply the patch, change the buildType with id = 'prodclouddataaccessbanffCloudDataAccess'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodclouddataaccessbanffCloudDataAccess")) {
    params {
        expect {
