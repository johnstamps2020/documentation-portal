...
To apply the patch, change the buildType with id = 'prodispc202011appPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011appPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
