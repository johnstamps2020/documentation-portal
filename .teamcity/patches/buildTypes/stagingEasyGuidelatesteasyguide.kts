...
To apply the patch, change the buildType with id = 'stagingEasyGuidelatesteasyguide'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingEasyGuidelatesteasyguide")) {
    expectSteps {
        script {
    ...
    steps {
        check(stepsOrder == arrayListOf("BUILD_DOC_SITE_OUTPUT", "BUILD_LOCAL_OUTPUT", "CREATE_ZIP_PACKAGE", "UPLOAD_GENERATED_CONTENT")) {
