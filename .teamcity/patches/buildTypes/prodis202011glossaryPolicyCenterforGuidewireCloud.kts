...
To apply the patch, change the buildType with id = 'prodis202011glossaryPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011glossaryPolicyCenterforGuidewireCloud")) {
    params {
        expect {
