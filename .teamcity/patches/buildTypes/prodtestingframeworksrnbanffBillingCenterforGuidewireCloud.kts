...
To apply the patch, change the buildType with id = 'prodtestingframeworksrnbanffBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksrnbanffBillingCenterforGuidewireCloud")) {
    params {
        expect {
