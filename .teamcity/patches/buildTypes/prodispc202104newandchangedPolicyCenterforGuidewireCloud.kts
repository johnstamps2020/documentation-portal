...
To apply the patch, change the buildType with id = 'prodispc202104newandchangedPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104newandchangedPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
