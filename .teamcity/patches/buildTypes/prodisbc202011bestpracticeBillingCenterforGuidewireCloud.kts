...
To apply the patch, change the buildType with id = 'prodisbc202011bestpracticeBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011bestpracticeBillingCenterforGuidewireCloud")) {
    params {
        expect {
