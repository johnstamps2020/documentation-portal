...
To apply the patch, change the buildType with id = 'proddxceqb1130CustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceqb1130CustomerEngageQuoteandBuy")) {
    check(paused == false) {
