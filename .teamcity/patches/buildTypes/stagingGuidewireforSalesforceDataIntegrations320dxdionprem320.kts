...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceDataIntegrations320dxdionprem320'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceDataIntegrations320dxdionprem320")) {
    params {
        expect {
