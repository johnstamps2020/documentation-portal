...
To apply the patch, change the buildType with id = 'intInsuranceNow20201xExternalAudiencelatestin20201xpadraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20201xExternalAudiencelatestin20201xpadraft")) {
    check(paused == false) {
