...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudearlyaccessiscccloudeaupgrade'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudearlyaccessiscccloudeaupgrade")) {
    check(paused == false) {
