...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20202in20202studiorn'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20202in20202studiorn")) {
    params {
        expect {
