...
To apply the patch, change the buildType with id = 'intInsuranceNow20202xInternalAudiencelatestin20202xcservicepconfigdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20202xInternalAudiencelatestin20202xcservicepconfigdraft")) {
    params {
        expect {
