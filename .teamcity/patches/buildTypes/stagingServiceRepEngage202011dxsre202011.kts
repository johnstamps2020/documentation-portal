...
To apply the patch, change the buildType with id = 'stagingServiceRepEngage202011dxsre202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingServiceRepEngage202011dxsre202011")) {
    check(paused == false) {
