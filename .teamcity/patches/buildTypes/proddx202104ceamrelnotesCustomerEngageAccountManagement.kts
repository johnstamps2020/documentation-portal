...
To apply the patch, change the buildType with id = 'proddx202104ceamrelnotesCustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceamrelnotesCustomerEngageAccountManagement")) {
    check(paused == false) {
