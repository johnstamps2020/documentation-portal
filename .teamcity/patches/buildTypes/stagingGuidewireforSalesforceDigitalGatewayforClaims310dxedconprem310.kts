...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceDigitalGatewayforClaims310dxedconprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceDigitalGatewayforClaims310dxedconprem310")) {
    params {
        expect {
