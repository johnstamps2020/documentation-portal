...
To apply the patch, change the buildType with id = 'stagingClaimCenter908selfmanagedccaaforoxt'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingClaimCenter908selfmanagedccaaforoxt")) {
    params {
        expect {
