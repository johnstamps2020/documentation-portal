    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cc/10.x
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cc/10.x/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cc/10.x/
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to the doc output dir"
