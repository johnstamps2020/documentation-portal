...
To apply the patch, change the buildType with id = 'stagingBillingCenterforGuidewireCloud202011isbc202011bestpractice'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenterforGuidewireCloud202011isbc202011bestpractice")) {
    check(paused == false) {
