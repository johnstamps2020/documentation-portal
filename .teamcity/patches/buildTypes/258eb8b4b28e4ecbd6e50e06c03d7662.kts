...
To apply the patch, change the buildType with id = '258eb8b4b28e4ecbd6e50e06c03d7662'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("258eb8b4b28e4ecbd6e50e06c03d7662")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/bc/202209/app --delete
            """.trimIndent()
