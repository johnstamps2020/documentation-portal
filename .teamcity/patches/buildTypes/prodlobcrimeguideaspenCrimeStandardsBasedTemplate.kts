...
To apply the patch, change the buildType with id = 'prodlobcrimeguideaspenCrimeStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobcrimeguideaspenCrimeStandardsBasedTemplate")) {
    check(paused == false) {
