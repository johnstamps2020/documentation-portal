...
To apply the patch, change the buildType with id = 'proddx202104peclaimsrelnotesProducerEngageforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104peclaimsrelnotesProducerEngageforClaimCenter")) {
    check(paused == false) {
