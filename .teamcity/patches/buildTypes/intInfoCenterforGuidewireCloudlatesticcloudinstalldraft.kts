...
To apply the patch, change the buildType with id = 'intInfoCenterforGuidewireCloudlatesticcloudinstalldraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInfoCenterforGuidewireCloudlatesticcloudinstalldraft")) {
    params {
        expect {
