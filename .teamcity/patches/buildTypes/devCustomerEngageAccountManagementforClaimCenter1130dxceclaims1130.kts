...
To apply the patch, change the buildType with id = 'devCustomerEngageAccountManagementforClaimCenter1130dxceclaims1130'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCustomerEngageAccountManagementforClaimCenter1130dxceclaims1130")) {
    params {
        expect {
