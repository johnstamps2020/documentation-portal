...
To apply the patch, change the buildType with id = 'devPolicyCenterforGuidewireCloud202011ispc202011restapifw'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenterforGuidewireCloud202011ispc202011restapifw")) {
    params {
        expect {
