...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202104dhcloudrncortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202104dhcloudrncortina")) {
    check(paused == false) {
