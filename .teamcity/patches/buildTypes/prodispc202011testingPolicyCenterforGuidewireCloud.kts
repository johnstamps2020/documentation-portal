...
To apply the patch, change the buildType with id = 'prodispc202011testingPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011testingPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
