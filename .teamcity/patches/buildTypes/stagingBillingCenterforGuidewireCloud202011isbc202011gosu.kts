...
To apply the patch, change the buildType with id = 'stagingBillingCenterforGuidewireCloud202011isbc202011gosu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenterforGuidewireCloud202011isbc202011gosu")) {
    check(paused == false) {
