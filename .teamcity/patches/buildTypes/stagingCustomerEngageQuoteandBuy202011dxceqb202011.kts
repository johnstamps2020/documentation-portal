...
To apply the patch, change the buildType with id = 'stagingCustomerEngageQuoteandBuy202011dxceqb202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCustomerEngageQuoteandBuy202011dxceqb202011")) {
    params {
        expect {
