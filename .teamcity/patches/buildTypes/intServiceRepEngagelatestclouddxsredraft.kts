...
To apply the patch, change the buildType with id = 'intServiceRepEngagelatestclouddxsredraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intServiceRepEngagelatestclouddxsredraft")) {
    params {
        expect {
