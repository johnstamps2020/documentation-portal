...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem610storybook610'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem610storybook610")) {
    check(paused == false) {
