...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202104cc202104apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202104cc202104apiref")) {
    check(paused == false) {
