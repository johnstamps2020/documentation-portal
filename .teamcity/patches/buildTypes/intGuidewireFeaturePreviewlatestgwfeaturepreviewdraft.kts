...
To apply the patch, change the buildType with id = 'intGuidewireFeaturePreviewlatestgwfeaturepreviewdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireFeaturePreviewlatestgwfeaturepreviewdraft")) {
    params {
        expect {
