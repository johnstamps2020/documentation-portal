...
To apply the patch, change the buildType with id = 'proddxdiapp330GuidewireforSalesforceDataIntegrations'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdiapp330GuidewireforSalesforceDataIntegrations")) {
    params {
        expect {
