...
To apply the patch, change the buildType with id = 'proddxvodadmin330GuidewireforSalesforceViewonDemand'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodadmin330GuidewireforSalesforceViewonDemand")) {
    check(paused == false) {
