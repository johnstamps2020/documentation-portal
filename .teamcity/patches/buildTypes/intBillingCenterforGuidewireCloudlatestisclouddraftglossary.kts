...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudlatestisclouddraftglossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudlatestisclouddraftglossary")) {
    params {
        expect {
