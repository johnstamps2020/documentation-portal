...
To apply the patch, change the buildType with id = 'prodis202104gosuClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202104gosuClaimCenterforGuidewireCloud")) {
    check(paused == false) {
