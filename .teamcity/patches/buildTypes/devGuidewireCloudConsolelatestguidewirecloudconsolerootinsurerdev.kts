...
To apply the patch, change the buildType with id = 'devGuidewireCloudConsolelatestguidewirecloudconsolerootinsurerdev'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireCloudConsolelatestguidewirecloudconsolerootinsurerdev")) {
    check(paused == false) {
