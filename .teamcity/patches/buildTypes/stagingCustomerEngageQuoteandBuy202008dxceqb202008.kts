...
To apply the patch, change the buildType with id = 'stagingCustomerEngageQuoteandBuy202008dxceqb202008'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCustomerEngageQuoteandBuy202008dxceqb202008")) {
    params {
        expect {
