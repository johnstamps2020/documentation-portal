...
To apply the patch, change the buildType with id = 'prodtestingframeworksuicortinaClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksuicortinaClaimCenterforGuidewireCloud")) {
    params {
        expect {
