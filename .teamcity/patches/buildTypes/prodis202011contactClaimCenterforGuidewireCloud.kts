...
To apply the patch, change the buildType with id = 'prodis202011contactClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011contactClaimCenterforGuidewireCloud")) {
    check(paused == false) {
