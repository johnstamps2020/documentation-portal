...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceViewonDemand320dxvodonprem320'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceViewonDemand320dxvodonprem320")) {
    params {
        expect {
