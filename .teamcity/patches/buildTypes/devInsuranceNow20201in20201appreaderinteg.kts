...
To apply the patch, change the buildType with id = 'devInsuranceNow20201in20201appreaderinteg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInsuranceNow20201in20201appreaderinteg")) {
    check(paused == false) {
