...
To apply the patch, change the buildType with id = 'prodtestingframeworksuibanffClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksuibanffClaimCenterforGuidewireCloud")) {
    params {
        expect {
