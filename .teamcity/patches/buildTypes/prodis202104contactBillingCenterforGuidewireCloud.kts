...
To apply the patch, change the buildType with id = 'prodis202104contactBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202104contactBillingCenterforGuidewireCloud")) {
    params {
        expect {
