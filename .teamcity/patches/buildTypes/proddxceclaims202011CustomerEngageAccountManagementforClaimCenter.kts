...
To apply the patch, change the buildType with id = 'proddxceclaims202011CustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceclaims202011CustomerEngageAccountManagementforClaimCenter")) {
    check(paused == false) {
