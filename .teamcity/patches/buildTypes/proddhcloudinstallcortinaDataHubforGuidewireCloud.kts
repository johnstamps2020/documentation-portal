...
To apply the patch, change the buildType with id = 'proddhcloudinstallcortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhcloudinstallcortinaDataHubforGuidewireCloud")) {
    check(paused == false) {
