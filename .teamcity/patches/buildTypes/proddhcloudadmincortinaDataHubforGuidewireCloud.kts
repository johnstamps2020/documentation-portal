...
To apply the patch, change the buildType with id = 'proddhcloudadmincortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhcloudadmincortinaDataHubforGuidewireCloud")) {
    params {
        expect {
