...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceDataIntegrationsforClaims310dxdiconprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceDataIntegrationsforClaims310dxdiconprem310")) {
    check(paused == false) {
