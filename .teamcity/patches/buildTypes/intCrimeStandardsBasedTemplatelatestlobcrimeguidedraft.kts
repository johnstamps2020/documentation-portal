...
To apply the patch, change the buildType with id = 'intCrimeStandardsBasedTemplatelatestlobcrimeguidedraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCrimeStandardsBasedTemplatelatestlobcrimeguidedraft")) {
    params {
        expect {
