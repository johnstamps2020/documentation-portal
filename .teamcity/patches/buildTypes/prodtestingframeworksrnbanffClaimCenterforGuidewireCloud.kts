...
To apply the patch, change the buildType with id = 'prodtestingframeworksrnbanffClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksrnbanffClaimCenterforGuidewireCloud")) {
    params {
        expect {
