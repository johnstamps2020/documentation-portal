...
To apply the patch, change the buildType with id = 'devClaimCenter1011selfmanagedccupgradeguide1011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenter1011selfmanagedccupgradeguide1011")) {
    check(paused == false) {
