...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xExternalAudiencelatestincsp324rndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xExternalAudiencelatestincsp324rndraft")) {
    check(paused == false) {
