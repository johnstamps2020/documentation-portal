...
To apply the patch, change the buildType with id = 'stagingDataHubforGuidewireCloud202104dhclouddevrefcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDataHubforGuidewireCloud202104dhclouddevrefcortina")) {
    expectSteps {
        script {
        ...
        script {
            ...
            scriptContent = """
                ...
                cp -R ./${'$'}RESOURCE_DIR/Cortina-10.5/DataHub/autoGenFiles/cloud/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/autoGenFiles/cloud/
            """.trimIndent()
        }
    }
    steps {
