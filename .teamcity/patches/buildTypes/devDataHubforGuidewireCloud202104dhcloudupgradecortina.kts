...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202104dhcloudupgradecortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202104dhcloudupgradecortina")) {
    params {
        expect {
