...
To apply the patch, change the buildType with id = 'intDigitalCodeGenerationExtensionPacklatestdxapdclouddraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDigitalCodeGenerationExtensionPacklatestdxapdclouddraft")) {
    params {
        expect {
