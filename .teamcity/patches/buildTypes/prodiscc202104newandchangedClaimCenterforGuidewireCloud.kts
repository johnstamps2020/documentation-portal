...
To apply the patch, change the buildType with id = 'prodiscc202104newandchangedClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104newandchangedClaimCenterforGuidewireCloud")) {
    check(paused == false) {
