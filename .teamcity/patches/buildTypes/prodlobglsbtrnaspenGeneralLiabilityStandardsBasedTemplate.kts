...
To apply the patch, change the buildType with id = 'prodlobglsbtrnaspenGeneralLiabilityStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobglsbtrnaspenGeneralLiabilityStandardsBasedTemplate")) {
    check(paused == false) {
