...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20211in20211cservicep'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20211in20211cservicep")) {
    check(paused == false) {
