...
To apply the patch, change the buildType with id = 'intGuidewireCloudConsolelatestguidewirecloudconsolerootgwadmin'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireCloudConsolelatestguidewirecloudconsolerootgwadmin")) {
    params {
        expect {
