...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xInternalAudiencelatestin20211xconfigdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xInternalAudiencelatestin20211xconfigdraft")) {
    check(paused == false) {
