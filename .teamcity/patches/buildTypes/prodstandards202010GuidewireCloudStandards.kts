...
To apply the patch, change the buildType with id = 'prodstandards202010GuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandards202010GuidewireCloudStandards")) {
    check(paused == false) {
