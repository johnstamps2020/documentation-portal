...
To apply the patch, change the buildType with id = 'proddxceam202010CustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceam202010CustomerEngageAccountManagement")) {
    check(paused == false) {
