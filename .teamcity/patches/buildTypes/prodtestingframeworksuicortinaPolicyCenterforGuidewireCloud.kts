...
To apply the patch, change the buildType with id = 'prodtestingframeworksuicortinaPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksuicortinaPolicyCenterforGuidewireCloud")) {
    params {
        expect {
