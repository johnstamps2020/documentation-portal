...
To apply the patch, change the buildType with id = '3bf7bf0bdbb22d80ca727323f8c835a4'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("3bf7bf0bdbb22d80ca727323f8c835a4")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/bc/202209/devsetup --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="isbc202209devsetup"
            ...
            scriptContent = """
                ...
                curl -O https://stash.guidewire.com/rest/api/1.0/projects/DOCSOURCES/repos/common-gw/raw/ditavals/IS-BC-Cloud-Release.ditaval \
                    ...
                    -H "Authorization: Bearer %env.BITBUCKET_ACCESS_TOKEN%"
                                ...
                                dita -i "%teamcity.build.checkoutDir%/DeveloperSetupGuide.ditamap" -o "%teamcity.build.checkoutDir%/out" --processing-mode "strict" --filter "%teamcity.build.checkoutDir%/common_gw_ditavals/IS-BC-Cloud-Release.ditaval" --gw-base-url "cloud/bc/202209/devsetup" --gw-doc-id "isbc202209devsetup" --gw-doc-title "Developer Setup" --generate.build.data "yes" --git.url "ssh://git@stash.guidewire.com/docsources/insurancesuite.git" --git.branch "release/2022.09.0" -f "html5-Guidewire" --args.rellinks "nofamily" --build.pdfs "yes" --create-index-redirect "yes" || EXIT_CODE=${'$'}?
