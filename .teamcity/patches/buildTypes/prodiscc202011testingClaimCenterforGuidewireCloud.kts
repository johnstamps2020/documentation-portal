...
To apply the patch, change the buildType with id = 'prodiscc202011testingClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011testingClaimCenterforGuidewireCloud")) {
    check(paused == false) {
