...
To apply the patch, change the buildType with id = 'prodisbc202104appBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104appBillingCenterforGuidewireCloud")) {
    check(paused == false) {
