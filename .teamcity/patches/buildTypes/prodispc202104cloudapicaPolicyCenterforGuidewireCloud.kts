...
To apply the patch, change the buildType with id = 'prodispc202104cloudapicaPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104cloudapicaPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
