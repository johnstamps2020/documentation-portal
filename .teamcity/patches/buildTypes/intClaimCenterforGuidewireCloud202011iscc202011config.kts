...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202011iscc202011config'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202011iscc202011config")) {
    params {
        expect {
