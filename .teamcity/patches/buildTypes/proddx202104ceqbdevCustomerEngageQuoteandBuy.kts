...
To apply the patch, change the buildType with id = 'proddx202104ceqbdevCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceqbdevCustomerEngageQuoteandBuy")) {
    check(paused == false) {
