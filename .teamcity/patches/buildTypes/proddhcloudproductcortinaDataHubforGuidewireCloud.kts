...
To apply the patch, change the buildType with id = 'proddhcloudproductcortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhcloudproductcortinaDataHubforGuidewireCloud")) {
    check(paused == false) {
