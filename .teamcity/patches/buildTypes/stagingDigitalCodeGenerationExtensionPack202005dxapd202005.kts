...
To apply the patch, change the buildType with id = 'stagingDigitalCodeGenerationExtensionPack202005dxapd202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDigitalCodeGenerationExtensionPack202005dxapd202005")) {
    check(paused == false) {
