...
To apply the patch, change the buildType with id = 'prodispc202104globalPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104globalPolicyCenterforGuidewireCloud")) {
    params {
        expect {
