...
To apply the patch, change the buildType with id = 'prodispc202011apdPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011apdPolicyCenterforGuidewireCloud")) {
    params {
        expect {
