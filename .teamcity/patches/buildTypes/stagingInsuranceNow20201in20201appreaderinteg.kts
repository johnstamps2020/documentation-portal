...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20201in20201appreaderinteg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20201in20201appreaderinteg")) {
    check(paused == false) {
