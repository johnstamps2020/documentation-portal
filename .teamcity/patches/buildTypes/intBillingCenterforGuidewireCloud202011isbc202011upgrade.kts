...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloud202011isbc202011upgrade'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloud202011isbc202011upgrade")) {
    params {
        expect {
