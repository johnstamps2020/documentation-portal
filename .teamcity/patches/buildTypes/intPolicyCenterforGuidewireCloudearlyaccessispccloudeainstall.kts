...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudearlyaccessispccloudeainstall'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudearlyaccessispccloudeainstall")) {
    check(paused == false) {
