...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem531LTSjutro531'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem531LTSjutro531")) {
    expectSteps {
        script {
