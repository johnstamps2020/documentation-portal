...
To apply the patch, change the buildType with id = 'prodisbc202011installBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011installBillingCenterforGuidewireCloud")) {
    params {
        expect {
