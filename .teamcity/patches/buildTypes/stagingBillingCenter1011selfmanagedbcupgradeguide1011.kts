...
To apply the patch, change the buildType with id = 'stagingBillingCenter1011selfmanagedbcupgradeguide1011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenter1011selfmanagedbcupgradeguide1011")) {
    params {
        expect {
