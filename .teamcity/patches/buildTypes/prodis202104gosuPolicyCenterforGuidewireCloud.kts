...
To apply the patch, change the buildType with id = 'prodis202104gosuPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202104gosuPolicyCenterforGuidewireCloud")) {
    params {
        expect {
