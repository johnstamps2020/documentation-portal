...
To apply the patch, change the buildType with id = 'proddxdirelnotes330GuidewireforSalesforceDataIntegrations'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdirelnotes330GuidewireforSalesforceDataIntegrations")) {
    check(paused == false) {
