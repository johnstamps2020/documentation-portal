...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceDigitalGatewayforClaims310dxedconprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceDigitalGatewayforClaims310dxedconprem310")) {
    params {
        expect {
