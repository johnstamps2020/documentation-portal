...
To apply the patch, change the buildType with id = 'prodconfigmgrhelpbanffConfigurationManager'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodconfigmgrhelpbanffConfigurationManager")) {
    params {
        expect {
