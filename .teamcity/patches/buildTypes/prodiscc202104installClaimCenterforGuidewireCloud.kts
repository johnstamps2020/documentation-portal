...
To apply the patch, change the buildType with id = 'prodiscc202104installClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104installClaimCenterforGuidewireCloud")) {
    params {
        expect {
