...
To apply the patch, change the buildType with id = 'intTestingFrameworkslatesttestingframeworksuidraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intTestingFrameworkslatesttestingframeworksuidraft")) {
    check(paused == false) {
