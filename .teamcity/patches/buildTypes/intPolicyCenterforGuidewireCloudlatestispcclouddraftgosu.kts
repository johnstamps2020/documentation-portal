...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudlatestispcclouddraftgosu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudlatestispcclouddraftgosu")) {
    check(paused == false) {
