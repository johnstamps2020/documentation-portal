...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202011ic202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202011ic202011")) {
    check(paused == false) {
