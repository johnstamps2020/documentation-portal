...
To apply the patch, change the buildType with id = 'intInfoCenterforGuidewireCloudlatesticcloudrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInfoCenterforGuidewireCloudlatesticcloudrndraft")) {
    check(paused == false) {
