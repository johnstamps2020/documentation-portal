...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudlatestispcclouddraftupgrade'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudlatestispcclouddraftupgrade")) {
    params {
        expect {
