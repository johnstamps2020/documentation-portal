...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceDigitalGateway310dxedonprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceDigitalGateway310dxedonprem310")) {
    check(paused == false) {
