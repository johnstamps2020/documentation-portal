...
To apply the patch, change the buildType with id = 'stagingCustomerEngageQuoteandBuy1130dxceqb1130'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCustomerEngageQuoteandBuy1130dxceqb1130")) {
    check(paused == false) {
