...
To apply the patch, change the buildType with id = 'prodispc202104releasenotesPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104releasenotesPolicyCenterforGuidewireCloud")) {
    params {
        expect {
