...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudlatestisbcclouddraftgosu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudlatestisbcclouddraftgosu")) {
    params {
        expect {
