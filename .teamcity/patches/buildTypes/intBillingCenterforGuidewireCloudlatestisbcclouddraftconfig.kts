...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudlatestisbcclouddraftconfig'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudlatestisbcclouddraftconfig")) {
    params {
        expect {
