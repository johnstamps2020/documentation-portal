...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202104dhcloudadmincortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202104dhcloudadmincortina")) {
    check(paused == false) {
