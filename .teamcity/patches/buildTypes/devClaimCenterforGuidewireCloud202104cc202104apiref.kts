...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202104cc202104apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202104cc202104apiref")) {
    expectSteps {
        script {
