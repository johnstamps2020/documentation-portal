...
To apply the patch, change the buildType with id = 'devCloudDataAccessAspenclouddataaccessaspen'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCloudDataAccessAspenclouddataaccessaspen")) {
    params {
        expect {
