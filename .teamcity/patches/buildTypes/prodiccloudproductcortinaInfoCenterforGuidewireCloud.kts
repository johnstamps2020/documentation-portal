...
To apply the patch, change the buildType with id = 'prodiccloudproductcortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudproductcortinaInfoCenterforGuidewireCloud")) {
    check(paused == false) {
