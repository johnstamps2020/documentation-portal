...
To apply the patch, change the buildType with id = 'proddx202104ceamrefguidesCustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceamrefguidesCustomerEngageAccountManagement")) {
    check(paused == false) {
