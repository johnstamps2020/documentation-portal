...
To apply the patch, change the buildType with id = 'stagingBillingCenterforGuidewireCloud202011isbc202011config'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenterforGuidewireCloud202011isbc202011config")) {
    check(paused == false) {
