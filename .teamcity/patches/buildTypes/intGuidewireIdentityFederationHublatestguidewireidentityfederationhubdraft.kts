...
To apply the patch, change the buildType with id = 'intGuidewireIdentityFederationHublatestguidewireidentityfederationhubdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireIdentityFederationHublatestguidewireidentityfederationhubdraft")) {
    params {
        expect {
