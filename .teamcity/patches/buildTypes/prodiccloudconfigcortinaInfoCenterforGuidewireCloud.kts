...
To apply the patch, change the buildType with id = 'prodiccloudconfigcortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudconfigcortinaInfoCenterforGuidewireCloud")) {
    params {
        expect {
