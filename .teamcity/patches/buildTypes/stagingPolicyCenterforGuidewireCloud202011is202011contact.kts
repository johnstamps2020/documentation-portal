...
To apply the patch, change the buildType with id = 'stagingPolicyCenterforGuidewireCloud202011is202011contact'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenterforGuidewireCloud202011is202011contact")) {
    check(paused == false) {
