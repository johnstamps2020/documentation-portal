...
To apply the patch, change the buildType with id = 'proddxedonprem310GuidewireforSalesforceDigitalGateway'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxedonprem310GuidewireforSalesforceDigitalGateway")) {
    params {
        expect {
