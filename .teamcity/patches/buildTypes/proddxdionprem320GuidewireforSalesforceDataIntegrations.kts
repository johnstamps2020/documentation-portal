...
To apply the patch, change the buildType with id = 'proddxdionprem320GuidewireforSalesforceDataIntegrations'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdionprem320GuidewireforSalesforceDataIntegrations")) {
    check(paused == false) {
