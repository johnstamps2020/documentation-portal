...
To apply the patch, change the buildType with id = 'prodis202104contactPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202104contactPolicyCenterforGuidewireCloud")) {
    params {
        expect {
