...
To apply the patch, change the buildType with id = 'prodispc202011configPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011configPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
