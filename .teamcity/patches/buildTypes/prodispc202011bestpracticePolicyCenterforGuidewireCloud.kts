...
To apply the patch, change the buildType with id = 'prodispc202011bestpracticePolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011bestpracticePolicyCenterforGuidewireCloud")) {
    params {
        expect {
