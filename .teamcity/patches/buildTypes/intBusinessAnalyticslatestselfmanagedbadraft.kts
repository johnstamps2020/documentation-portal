...
To apply the patch, change the buildType with id = 'intBusinessAnalyticslatestselfmanagedbadraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBusinessAnalyticslatestselfmanagedbadraft")) {
    params {
        expect {
