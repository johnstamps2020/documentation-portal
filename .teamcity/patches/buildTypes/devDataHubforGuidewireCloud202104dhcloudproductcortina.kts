...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202104dhcloudproductcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202104dhcloudproductcortina")) {
    params {
        expect {
