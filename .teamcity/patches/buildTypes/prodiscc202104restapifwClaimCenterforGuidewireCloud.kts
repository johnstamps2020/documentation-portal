...
To apply the patch, change the buildType with id = 'prodiscc202104restapifwClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104restapifwClaimCenterforGuidewireCloud")) {
    params {
        expect {
