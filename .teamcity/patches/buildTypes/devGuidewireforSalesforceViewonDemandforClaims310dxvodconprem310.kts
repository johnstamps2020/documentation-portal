...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceViewonDemandforClaims310dxvodconprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceViewonDemandforClaims310dxvodconprem310")) {
    params {
        expect {
