...
To apply the patch, change the buildType with id = 'devBillingCenterforGuidewireCloud202011is202011glossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenterforGuidewireCloud202011is202011glossary")) {
    check(paused == false) {
