...
To apply the patch, change the buildType with id = 'prodtestingframeworksapicortinaPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksapicortinaPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
