...
To apply the patch, change the buildType with id = 'devTestingFrameworks202011testingframeworksuibanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devTestingFrameworks202011testingframeworksuibanff")) {
    check(paused == false) {
