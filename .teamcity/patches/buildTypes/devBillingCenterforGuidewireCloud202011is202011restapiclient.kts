...
To apply the patch, change the buildType with id = 'devBillingCenterforGuidewireCloud202011is202011restapiclient'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenterforGuidewireCloud202011is202011restapiclient")) {
    check(paused == false) {
