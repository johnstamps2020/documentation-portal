...
To apply the patch, change the buildType with id = 'devClaimCenter908selfmanagedccaaforoxt'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenter908selfmanagedccaaforoxt")) {
    params {
        expect {
