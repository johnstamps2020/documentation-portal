...
To apply the patch, change the buildType with id = 'prodselfmanagedbcupgradeguide1011BillingCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedbcupgradeguide1011BillingCenter")) {
    check(paused == false) {
