...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceDigitalGateway320dxedonprem320'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceDigitalGateway320dxedonprem320")) {
    params {
        expect {
