...
To apply the patch, change the buildType with id = 'proddx202104ceamappCustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceamappCustomerEngageAccountManagement")) {
    check(paused == false) {
