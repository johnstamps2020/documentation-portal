...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudearlyaccessisbccloudeabestpractice'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudearlyaccessisbccloudeabestpractice")) {
    check(paused == false) {
