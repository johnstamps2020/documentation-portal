...
To apply the patch, change the buildType with id = 'stagingTestingFrameworks202011testingframeworksapibanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingTestingFrameworks202011testingframeworksapibanff")) {
    params {
        expect {
