...
To apply the patch, change the buildType with id = 'stagingProducerEngageforClaimCenter202010dxpeclaims202010'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingProducerEngageforClaimCenter202010dxpeclaims202010")) {
    check(paused == false) {
