...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202104iscc202104releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202104iscc202104releasenotes")) {
    check(paused == false) {
