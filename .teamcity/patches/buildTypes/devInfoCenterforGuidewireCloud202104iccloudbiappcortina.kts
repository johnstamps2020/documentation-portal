...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202104iccloudbiappcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202104iccloudbiappcortina")) {
    params {
        expect {
