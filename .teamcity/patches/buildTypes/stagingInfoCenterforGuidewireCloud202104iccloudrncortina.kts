    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/releaseDiffFiles/cloud
                cp -R ./${'$'}RESOURCE_DIR/Cortina-10.5/InfoCenter/releaseDiffFiles/cloud/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/releaseDiffFiles/cloud/
            """.trimIndent()
        }
    }
    steps {
