...
To apply the patch, change the buildType with id = 'prodiccloudupgradecortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudupgradecortinaInfoCenterforGuidewireCloud")) {
    check(paused == false) {
