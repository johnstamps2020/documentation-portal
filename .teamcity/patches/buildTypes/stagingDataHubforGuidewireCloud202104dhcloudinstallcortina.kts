...
To apply the patch, change the buildType with id = 'stagingDataHubforGuidewireCloud202104dhcloudinstallcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDataHubforGuidewireCloud202104dhcloudinstallcortina")) {
    params {
        expect {
