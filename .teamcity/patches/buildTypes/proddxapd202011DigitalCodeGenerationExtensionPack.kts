...
To apply the patch, change the buildType with id = 'proddxapd202011DigitalCodeGenerationExtensionPack'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxapd202011DigitalCodeGenerationExtensionPack")) {
    params {
        expect {
