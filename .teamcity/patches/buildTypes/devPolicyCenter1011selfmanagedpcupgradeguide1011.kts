...
To apply the patch, change the buildType with id = 'devPolicyCenter1011selfmanagedpcupgradeguide1011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenter1011selfmanagedpcupgradeguide1011")) {
    params {
        expect {
