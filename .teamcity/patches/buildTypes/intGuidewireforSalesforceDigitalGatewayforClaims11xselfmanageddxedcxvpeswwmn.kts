...
To apply the patch, change the buildType with id = 'intGuidewireforSalesforceDigitalGatewayforClaims11xselfmanageddxedcxvpeswwmn'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireforSalesforceDigitalGatewayforClaims11xselfmanageddxedcxvpeswwmn")) {
    params {
        expect {
