...
To apply the patch, change the buildType with id = 'proddxceqb202008CustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceqb202008CustomerEngageQuoteandBuy")) {
    params {
        expect {
