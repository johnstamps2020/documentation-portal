    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/pc/2021.04
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/pc/2021.04/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/pc/2021.04/
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to the doc output dir"
