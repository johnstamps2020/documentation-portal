...
To apply the patch, change the buildType with id = 'intPolicyCenter9xselfmanagedpcxxbkttzbb'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenter9xselfmanagedpcxxbkttzbb")) {
    params {
        expect {
