...
To apply the patch, change the buildType with id = 'prodispc202011upgradePolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011upgradePolicyCenterforGuidewireCloud")) {
    params {
        expect {
