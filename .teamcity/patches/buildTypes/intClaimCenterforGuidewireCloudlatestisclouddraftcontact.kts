...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudlatestisclouddraftcontact'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudlatestisclouddraftcontact")) {
    check(paused == false) {
