...
To apply the patch, change the buildType with id = 'stagingExplorelatestexplorecloudrelease'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingExplorelatestexplorecloudrelease")) {
    check(paused == false) {
