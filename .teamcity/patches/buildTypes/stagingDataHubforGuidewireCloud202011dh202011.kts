...
To apply the patch, change the buildType with id = 'stagingDataHubforGuidewireCloud202011dh202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDataHubforGuidewireCloud202011dh202011")) {
    check(paused == false) {
