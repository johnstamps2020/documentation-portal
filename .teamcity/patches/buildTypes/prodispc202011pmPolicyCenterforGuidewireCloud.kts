...
To apply the patch, change the buildType with id = 'prodispc202011pmPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011pmPolicyCenterforGuidewireCloud")) {
    params {
        expect {
