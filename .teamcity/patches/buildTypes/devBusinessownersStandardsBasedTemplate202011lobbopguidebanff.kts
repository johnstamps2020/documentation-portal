...
To apply the patch, change the buildType with id = 'devBusinessownersStandardsBasedTemplate202011lobbopguidebanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBusinessownersStandardsBasedTemplate202011lobbopguidebanff")) {
    params {
        expect {
