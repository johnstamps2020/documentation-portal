...
To apply the patch, change the buildType with id = 'intStringManagerlateststringmanagerlatest'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intStringManagerlateststringmanagerlatest")) {
    check(paused == false) {
