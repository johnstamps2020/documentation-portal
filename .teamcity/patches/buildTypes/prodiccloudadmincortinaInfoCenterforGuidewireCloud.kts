...
To apply the patch, change the buildType with id = 'prodiccloudadmincortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudadmincortinaInfoCenterforGuidewireCloud")) {
    params {
        expect {
