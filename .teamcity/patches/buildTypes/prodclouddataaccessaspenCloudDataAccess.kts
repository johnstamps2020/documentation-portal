...
To apply the patch, change the buildType with id = 'prodclouddataaccessaspenCloudDataAccess'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodclouddataaccessaspenCloudDataAccess")) {
    params {
        expect {
