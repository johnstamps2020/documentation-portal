...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202011iscc202011cloudapi'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202011iscc202011cloudapi")) {
    check(paused == false) {
