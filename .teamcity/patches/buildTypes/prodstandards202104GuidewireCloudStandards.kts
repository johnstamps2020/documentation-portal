...
To apply the patch, change the buildType with id = 'prodstandards202104GuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandards202104GuidewireCloudStandards")) {
    params {
        expect {
