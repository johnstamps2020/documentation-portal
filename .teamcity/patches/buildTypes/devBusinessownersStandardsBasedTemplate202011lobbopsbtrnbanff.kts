...
To apply the patch, change the buildType with id = 'devBusinessownersStandardsBasedTemplate202011lobbopsbtrnbanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBusinessownersStandardsBasedTemplate202011lobbopsbtrnbanff")) {
    params {
        expect {
