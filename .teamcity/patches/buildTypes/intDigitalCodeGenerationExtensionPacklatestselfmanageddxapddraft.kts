...
To apply the patch, change the buildType with id = 'intDigitalCodeGenerationExtensionPacklatestselfmanageddxapddraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDigitalCodeGenerationExtensionPacklatestselfmanageddxapddraft")) {
    check(paused == false) {
