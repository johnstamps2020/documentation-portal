...
To apply the patch, change the buildType with id = 'stagingGuidewireCloudStandards202011standards202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireCloudStandards202011standards202011")) {
    params {
        expect {
