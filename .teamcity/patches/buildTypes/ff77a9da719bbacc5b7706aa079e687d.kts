...
To apply the patch, change the buildType with id = 'ff77a9da719bbacc5b7706aa079e687d'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("ff77a9da719bbacc5b7706aa079e687d")) {
    check(paused == false) {
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/cc/202302/app --delete
            """.trimIndent()
            ...
            scriptContent = """
                ...
                curl -O https://stash.guidewire.com/rest/api/1.0/projects/DOCSOURCES/repos/common-gw/raw/ditavals/IS-CC-Cloud-Release.ditaval \
                    ...
                    -H "Authorization: Bearer %env.BITBUCKET_ACCESS_TOKEN%"
                                ...
                                dita -i "%teamcity.build.checkoutDir%/CC-AppGuide.ditamap" -o "%teamcity.build.checkoutDir%/out" --processing-mode "strict" --filter "%teamcity.build.checkoutDir%/common_gw_ditavals/IS-CC-Cloud-Release.ditaval" --gw-base-url "cloud/cc/202302/app" --gw-doc-id "iscc202302app" --gw-doc-title "Application Guide" --generate.build.data "yes" --git.url "ssh://git@stash.guidewire.com/docsources/insurancesuite.git" --git.branch "release/2023.02.0" -f "html5-Guidewire" --args.rellinks "nofamily" --build.pdfs "yes" --create-index-redirect "yes" || EXIT_CODE=${'$'}?
