...
To apply the patch, change the buildType with id = 'prodlobbopguideaspenBusinessownersStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobbopguideaspenBusinessownersStandardsBasedTemplate")) {
    params {
        expect {
