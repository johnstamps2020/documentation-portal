...
To apply the patch, change the buildType with id = 'intInsuranceNow20201xInternalAudiencelatestincsp323rndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20201xInternalAudiencelatestincsp323rndraft")) {
    check(paused == false) {
