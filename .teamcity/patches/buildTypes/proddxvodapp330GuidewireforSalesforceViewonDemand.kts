...
To apply the patch, change the buildType with id = 'proddxvodapp330GuidewireforSalesforceViewonDemand'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodapp330GuidewireforSalesforceViewonDemand")) {
    params {
        expect {
