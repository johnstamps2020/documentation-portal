...
To apply the patch, change the buildType with id = 'intServiceRepEngage11xselfmanageddxsredraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intServiceRepEngage11xselfmanageddxsredraft")) {
    check(paused == false) {
