...
To apply the patch, change the buildType with id = 'devCustomerEngageAccountManagementforClaimCenter202010dxceclaims202010'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCustomerEngageAccountManagementforClaimCenter202010dxceclaims202010")) {
    check(paused == false) {
