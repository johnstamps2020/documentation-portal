...
To apply the patch, change the buildType with id = 'prodiscc202104testingClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104testingClaimCenterforGuidewireCloud")) {
    params {
        expect {
