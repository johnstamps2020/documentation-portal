...
To apply the patch, change the buildType with id = 'prodiccloudrncortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudrncortinaInfoCenterforGuidewireCloud")) {
    check(paused == false) {
