...
To apply the patch, change the buildType with id = '35096ddd89c43de23ad23f6c20e71ace'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("35096ddd89c43de23ad23f6c20e71ace")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/cc/202209/cloudapica --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                curl -O https://stash.guidewire.com/rest/api/1.0/projects/DOCSOURCES/repos/common-gw/raw/ditavals/IS-CC-Cloud-Release.ditaval \
                    -H "Accept: application/json" \
                    -H "Authorization: Bearer %env.BITBUCKET_ACCESS_TOKEN%"
                
                                echo "Building output"
                                dita -i "%teamcity.build.checkoutDir%/CloudAPI-Developer.ditamap" -o "%teamcity.build.checkoutDir%/out" --processing-mode "strict" --filter "%teamcity.build.checkoutDir%/common_gw_ditavals/IS-CC-Cloud-Release.ditaval" --gw-base-url "cloud/cc/202209/cloudapica" --gw-doc-id "iscc202209apica" --gw-doc-title "Cloud API Developer Guide" --generate.build.data "yes" --git.url "ssh://git@stash.guidewire.com/docsources/insurancesuite.git" --git.branch "release/2022.09.0" -f "html5-Guidewire" --args.rellinks "nofamily" --build.pdfs "yes" --create-index-redirect "yes" || EXIT_CODE=${'$'}?
