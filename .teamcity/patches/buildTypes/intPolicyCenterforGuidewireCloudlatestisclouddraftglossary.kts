...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudlatestisclouddraftglossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudlatestisclouddraftglossary")) {
    check(paused == false) {
