...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202011cc202011apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202011cc202011apiref")) {
    check(paused == false) {
