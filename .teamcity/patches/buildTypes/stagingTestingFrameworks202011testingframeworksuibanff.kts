...
To apply the patch, change the buildType with id = 'stagingTestingFrameworks202011testingframeworksuibanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingTestingFrameworks202011testingframeworksuibanff")) {
    check(paused == false) {
