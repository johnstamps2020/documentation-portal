...
To apply the patch, change the buildType with id = 'prodiscc202011adminClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011adminClaimCenterforGuidewireCloud")) {
    params {
        expect {
