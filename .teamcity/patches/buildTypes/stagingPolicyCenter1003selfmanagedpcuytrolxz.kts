...
To apply the patch, change the buildType with id = 'stagingPolicyCenter1003selfmanagedpcuytrolxz'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenter1003selfmanagedpcuytrolxz")) {
    check(paused == false) {
