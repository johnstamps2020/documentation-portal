...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem520storybook520'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem520storybook520")) {
    expectSteps {
        script {
