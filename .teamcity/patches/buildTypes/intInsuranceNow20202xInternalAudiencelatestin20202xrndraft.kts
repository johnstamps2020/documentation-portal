...
To apply the patch, change the buildType with id = 'intInsuranceNow20202xInternalAudiencelatestin20202xrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20202xInternalAudiencelatestin20202xrndraft")) {
    check(paused == false) {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ChangedFiles/2020.2/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/ReleaseNotes/2020.2.x/ChangedFiles --delete
            """.trimIndent()
        }
    }
    steps {
