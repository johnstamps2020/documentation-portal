    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/ReleaseNotes/2020.2.x/ChangedFiles
                cp -R ./${'$'}RESOURCE_DIR/ChangedFiles/2020.2/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/ReleaseNotes/2020.2.x/ChangedFiles/
            """.trimIndent()
        }
    }
    steps {
