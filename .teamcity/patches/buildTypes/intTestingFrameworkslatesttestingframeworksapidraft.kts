...
To apply the patch, change the buildType with id = 'intTestingFrameworkslatesttestingframeworksapidraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intTestingFrameworkslatesttestingframeworksapidraft")) {
    params {
        expect {
