...
To apply the patch, change the buildType with id = 'prodlobcrimesbtrnaspenCrimeStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobcrimesbtrnaspenCrimeStandardsBasedTemplate")) {
    check(paused == false) {
