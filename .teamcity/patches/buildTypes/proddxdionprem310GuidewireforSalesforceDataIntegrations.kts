...
To apply the patch, change the buildType with id = 'proddxdionprem310GuidewireforSalesforceDataIntegrations'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdionprem310GuidewireforSalesforceDataIntegrations")) {
    check(paused == false) {
