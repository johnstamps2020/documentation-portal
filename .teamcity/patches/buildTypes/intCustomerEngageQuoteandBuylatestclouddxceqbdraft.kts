...
To apply the patch, change the buildType with id = 'intCustomerEngageQuoteandBuylatestclouddxceqbdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCustomerEngageQuoteandBuylatestclouddxceqbdraft")) {
    params {
        expect {
