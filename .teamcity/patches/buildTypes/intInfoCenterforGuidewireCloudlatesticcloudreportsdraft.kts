...
To apply the patch, change the buildType with id = 'intInfoCenterforGuidewireCloudlatesticcloudreportsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInfoCenterforGuidewireCloudlatesticcloudreportsdraft")) {
    check(paused == false) {
