...
To apply the patch, change the buildType with id = 'stagingInfoCenterforGuidewireCloud202104iccloudreportscortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInfoCenterforGuidewireCloud202104iccloudreportscortina")) {
    check(paused == false) {
