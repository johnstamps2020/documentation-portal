...
To apply the patch, change the buildType with id = 'stagingServiceRepEngage202010dxsre202010'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingServiceRepEngage202010dxsre202010")) {
    check(paused == false) {
