...
To apply the patch, change the buildType with id = 'prodiscc202011cloudapicaClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011cloudapicaClaimCenterforGuidewireCloud")) {
    params {
        expect {
