...
To apply the patch, change the buildType with id = 'stagingBusinessownersStandardsBasedTemplate202005lobbopguideaspen'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBusinessownersStandardsBasedTemplate202005lobbopguideaspen")) {
    params {
        expect {
