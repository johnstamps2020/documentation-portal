...
To apply the patch, change the buildType with id = 'prodiscc202104adminClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104adminClaimCenterforGuidewireCloud")) {
    check(paused == false) {
