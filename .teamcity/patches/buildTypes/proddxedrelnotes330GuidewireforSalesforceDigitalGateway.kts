...
To apply the patch, change the buildType with id = 'proddxedrelnotes330GuidewireforSalesforceDigitalGateway'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxedrelnotes330GuidewireforSalesforceDigitalGateway")) {
    check(paused == false) {
