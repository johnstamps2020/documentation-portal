...
To apply the patch, change the buildType with id = 'stagingBillingCenter909selfmanagedbcupgradetools1450'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenter909selfmanagedbcupgradetools1450")) {
    check(paused == false) {
