...
To apply the patch, change the buildType with id = 'prodispc202011cloudapiPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011cloudapiPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
