...
To apply the patch, change the buildType with id = 'prodtestingframeworksapibanffPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksapibanffPolicyCenterforGuidewireCloud")) {
    params {
        expect {
