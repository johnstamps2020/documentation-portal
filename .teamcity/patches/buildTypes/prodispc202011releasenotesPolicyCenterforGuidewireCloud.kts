...
To apply the patch, change the buildType with id = 'prodispc202011releasenotesPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011releasenotesPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
