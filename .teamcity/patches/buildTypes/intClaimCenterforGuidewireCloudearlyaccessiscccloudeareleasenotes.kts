    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cc/2020.11
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cc/2020.11/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cc/2020.11/
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to the doc output dir"
