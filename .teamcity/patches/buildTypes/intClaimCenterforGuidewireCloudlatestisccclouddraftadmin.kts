...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudlatestisccclouddraftadmin'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudlatestisccclouddraftadmin")) {
    check(paused == false) {
