...
To apply the patch, change the buildType with id = 'prodiscc202011restapifwClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011restapifwClaimCenterforGuidewireCloud")) {
    params {
        expect {
