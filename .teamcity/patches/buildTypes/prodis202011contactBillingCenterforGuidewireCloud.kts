...
To apply the patch, change the buildType with id = 'prodis202011contactBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011contactBillingCenterforGuidewireCloud")) {
    params {
        expect {
