...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem500storybook500'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem500storybook500")) {
    params {
        expect {
