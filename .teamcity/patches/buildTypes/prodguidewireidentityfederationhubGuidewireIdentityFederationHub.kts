...
To apply the patch, change the buildType with id = 'prodguidewireidentityfederationhubGuidewireIdentityFederationHub'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodguidewireidentityfederationhubGuidewireIdentityFederationHub")) {
    params {
        expect {
