...
To apply the patch, change the buildType with id = 'proddxceam202008CustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceam202008CustomerEngageAccountManagement")) {
    params {
        expect {
