...
To apply the patch, change the buildType with id = 'intGeneralLiabilityStandardsBasedTemplatelatestlobglguidedraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGeneralLiabilityStandardsBasedTemplatelatestlobglguidedraft")) {
    params {
        expect {
