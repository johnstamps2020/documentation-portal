...
To apply the patch, change the buildType with id = 'prodstandards202011GuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandards202011GuidewireCloudStandards")) {
    check(paused == false) {
