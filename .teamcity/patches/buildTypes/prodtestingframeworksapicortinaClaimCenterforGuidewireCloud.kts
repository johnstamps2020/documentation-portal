...
To apply the patch, change the buildType with id = 'prodtestingframeworksapicortinaClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksapicortinaClaimCenterforGuidewireCloud")) {
    params {
        expect {
