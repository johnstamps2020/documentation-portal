...
To apply the patch, change the buildType with id = 'stagingInfoCenterforGuidewireCloud202104icclouddevrefcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInfoCenterforGuidewireCloud202104icclouddevrefcortina")) {
    expectSteps {
        script {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/autoGenFiles/cloud
                cp -R ./${'$'}RESOURCE_DIR/Cortina-10.5/InfoCenter/autoGenFiles/cloud/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/autoGenFiles/cloud/
            """.trimIndent()
        }
    }
    steps {
