...
To apply the patch, change the buildType with id = 'prodcloudpc202005PolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodcloudpc202005PolicyCenterforGuidewireCloud")) {
    check(paused == false) {
