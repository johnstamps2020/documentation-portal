...
To apply the patch, change the buildType with id = 'devGuidewireIdentityFederationHublatestguidewireidentityfederationhubbanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireIdentityFederationHublatestguidewireidentityfederationhubbanff")) {
    params {
        expect {
