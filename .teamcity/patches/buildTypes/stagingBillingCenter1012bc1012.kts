...
To apply the patch, change the buildType with id = 'stagingBillingCenter1012bc1012'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenter1012bc1012")) {
    expectSteps {
        script {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/10.x
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/bc/10.x/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/10.x/
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to the doc output dir"
            ...
            scriptContent = """
                ...
                echo "Copying files to the doc output dir"
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cm/10.x
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cm/10.x/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cm/10.x/
            """.trimIndent()
        }
    }
    steps {
