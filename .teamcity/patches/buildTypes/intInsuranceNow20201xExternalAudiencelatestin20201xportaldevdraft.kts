...
To apply the patch, change the buildType with id = 'intInsuranceNow20201xExternalAudiencelatestin20201xportaldevdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20201xExternalAudiencelatestin20201xportaldevdraft")) {
    params {
        expect {
