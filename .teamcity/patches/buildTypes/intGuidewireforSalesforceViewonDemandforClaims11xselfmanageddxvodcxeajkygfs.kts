...
To apply the patch, change the buildType with id = 'intGuidewireforSalesforceViewonDemandforClaims11xselfmanageddxvodcxeajkygfs'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireforSalesforceViewonDemandforClaims11xselfmanageddxvodcxeajkygfs")) {
    check(paused == false) {
