...
To apply the patch, change the buildType with id = 'prodispc202104pdPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104pdPolicyCenterforGuidewireCloud")) {
    params {
        expect {
