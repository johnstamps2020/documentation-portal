...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202005cloudcc202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202005cloudcc202005")) {
    params {
        expect {
