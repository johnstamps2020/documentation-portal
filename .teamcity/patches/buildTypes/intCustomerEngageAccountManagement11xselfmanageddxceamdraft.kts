...
To apply the patch, change the buildType with id = 'intCustomerEngageAccountManagement11xselfmanageddxceamdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCustomerEngageAccountManagement11xselfmanageddxceamdraft")) {
    check(paused == false) {
