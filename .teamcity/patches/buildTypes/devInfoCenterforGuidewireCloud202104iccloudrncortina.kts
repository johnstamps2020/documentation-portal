...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202104iccloudrncortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202104iccloudrncortina")) {
    params {
        expect {
