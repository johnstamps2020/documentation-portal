...
To apply the patch, change the buildType with id = 'prodis202104contactClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202104contactClaimCenterforGuidewireCloud")) {
    params {
        expect {
