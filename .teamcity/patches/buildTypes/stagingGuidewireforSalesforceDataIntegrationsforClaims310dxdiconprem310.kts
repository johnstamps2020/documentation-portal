...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceDataIntegrationsforClaims310dxdiconprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceDataIntegrationsforClaims310dxdiconprem310")) {
    check(paused == false) {
