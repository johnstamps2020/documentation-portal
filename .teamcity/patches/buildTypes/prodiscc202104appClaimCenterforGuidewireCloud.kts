...
To apply the patch, change the buildType with id = 'prodiscc202104appClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104appClaimCenterforGuidewireCloud")) {
    check(paused == false) {
