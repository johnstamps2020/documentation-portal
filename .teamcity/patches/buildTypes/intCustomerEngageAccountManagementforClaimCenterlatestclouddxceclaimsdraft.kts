...
To apply the patch, change the buildType with id = 'intCustomerEngageAccountManagementforClaimCenterlatestclouddxceclaimsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCustomerEngageAccountManagementforClaimCenterlatestclouddxceclaimsdraft")) {
    check(paused == false) {
