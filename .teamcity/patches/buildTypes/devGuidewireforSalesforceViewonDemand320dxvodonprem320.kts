...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceViewonDemand320dxvodonprem320'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceViewonDemand320dxvodonprem320")) {
    params {
        expect {
