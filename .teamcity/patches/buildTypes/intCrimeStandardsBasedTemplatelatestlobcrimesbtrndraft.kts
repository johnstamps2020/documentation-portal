...
To apply the patch, change the buildType with id = 'intCrimeStandardsBasedTemplatelatestlobcrimesbtrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCrimeStandardsBasedTemplatelatestlobcrimesbtrndraft")) {
    params {
        expect {
