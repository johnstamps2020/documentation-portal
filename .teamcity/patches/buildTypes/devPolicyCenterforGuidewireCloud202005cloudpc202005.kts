...
To apply the patch, change the buildType with id = 'devPolicyCenterforGuidewireCloud202005cloudpc202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenterforGuidewireCloud202005cloudpc202005")) {
    check(paused == false) {
