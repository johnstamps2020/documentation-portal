...
To apply the patch, change the buildType with id = 'stagingInfoCenterforGuidewireCloud202104iccloudinstallcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInfoCenterforGuidewireCloud202104iccloudinstallcortina")) {
    check(paused == false) {
