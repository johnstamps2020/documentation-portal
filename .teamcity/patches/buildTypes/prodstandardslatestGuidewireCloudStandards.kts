...
To apply the patch, change the buildType with id = 'prodstandardslatestGuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandardslatestGuidewireCloudStandards")) {
    params {
        expect {
