...
To apply the patch, change the buildType with id = 'intGuidewireforSalesforceDigitalGateway11xselfmanageddxedxqqjwvkln'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireforSalesforceDigitalGateway11xselfmanageddxedxqqjwvkln")) {
    params {
        expect {
