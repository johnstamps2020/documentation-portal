...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceDigitalGateway310dxedonprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceDigitalGateway310dxedonprem310")) {
    check(paused == false) {
