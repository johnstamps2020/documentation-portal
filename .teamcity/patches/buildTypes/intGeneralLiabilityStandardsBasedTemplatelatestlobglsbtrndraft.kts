...
To apply the patch, change the buildType with id = 'intGeneralLiabilityStandardsBasedTemplatelatestlobglsbtrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGeneralLiabilityStandardsBasedTemplatelatestlobglsbtrndraft")) {
    check(paused == false) {
