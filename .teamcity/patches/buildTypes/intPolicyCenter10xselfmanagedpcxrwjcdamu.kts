...
To apply the patch, change the buildType with id = 'intPolicyCenter10xselfmanagedpcxrwjcdamu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenter10xselfmanagedpcxrwjcdamu")) {
    check(paused == false) {
