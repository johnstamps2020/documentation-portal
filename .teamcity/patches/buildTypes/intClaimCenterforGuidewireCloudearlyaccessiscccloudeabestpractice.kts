...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudearlyaccessiscccloudeabestpractice'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudearlyaccessiscccloudeabestpractice")) {
    check(paused == false) {
