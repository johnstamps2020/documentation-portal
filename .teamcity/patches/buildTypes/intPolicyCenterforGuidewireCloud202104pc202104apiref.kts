...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloud202104pc202104apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloud202104pc202104apiref")) {
    check(paused == false) {
