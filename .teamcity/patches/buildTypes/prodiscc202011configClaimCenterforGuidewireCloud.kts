...
To apply the patch, change the buildType with id = 'prodiscc202011configClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011configClaimCenterforGuidewireCloud")) {
    params {
        expect {
