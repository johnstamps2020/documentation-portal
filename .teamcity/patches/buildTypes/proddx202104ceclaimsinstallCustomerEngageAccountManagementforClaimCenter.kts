...
To apply the patch, change the buildType with id = 'proddx202104ceclaimsinstallCustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceclaimsinstallCustomerEngageAccountManagementforClaimCenter")) {
    check(paused == false) {
