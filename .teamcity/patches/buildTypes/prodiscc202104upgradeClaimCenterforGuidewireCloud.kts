...
To apply the patch, change the buildType with id = 'prodiscc202104upgradeClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104upgradeClaimCenterforGuidewireCloud")) {
    check(paused == false) {
