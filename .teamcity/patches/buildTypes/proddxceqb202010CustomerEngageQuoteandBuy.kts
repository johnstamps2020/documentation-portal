...
To apply the patch, change the buildType with id = 'proddxceqb202010CustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceqb202010CustomerEngageQuoteandBuy")) {
    check(paused == false) {
