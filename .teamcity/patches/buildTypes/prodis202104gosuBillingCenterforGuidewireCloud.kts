...
To apply the patch, change the buildType with id = 'prodis202104gosuBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202104gosuBillingCenterforGuidewireCloud")) {
    check(paused == false) {
