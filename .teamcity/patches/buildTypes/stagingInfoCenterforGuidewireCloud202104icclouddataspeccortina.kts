...
To apply the patch, change the buildType with id = 'stagingInfoCenterforGuidewireCloud202104icclouddataspeccortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInfoCenterforGuidewireCloud202104icclouddataspeccortina")) {
    params {
        expect {
