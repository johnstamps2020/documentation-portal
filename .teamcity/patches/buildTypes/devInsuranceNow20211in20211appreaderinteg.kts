...
To apply the patch, change the buildType with id = 'devInsuranceNow20211in20211appreaderinteg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInsuranceNow20211in20211appreaderinteg")) {
    params {
        expect {
