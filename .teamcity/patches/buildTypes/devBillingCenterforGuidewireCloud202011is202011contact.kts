...
To apply the patch, change the buildType with id = 'devBillingCenterforGuidewireCloud202011is202011contact'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenterforGuidewireCloud202011is202011contact")) {
    check(paused == false) {
