...
To apply the patch, change the buildType with id = 'prodtestingframeworksuibanffPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksuibanffPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
