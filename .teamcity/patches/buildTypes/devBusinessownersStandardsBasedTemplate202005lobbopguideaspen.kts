...
To apply the patch, change the buildType with id = 'devBusinessownersStandardsBasedTemplate202005lobbopguideaspen'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBusinessownersStandardsBasedTemplate202005lobbopguideaspen")) {
    params {
        expect {
