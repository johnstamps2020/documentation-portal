...
To apply the patch, change the buildType with id = 'devBusinessownersStandardsBasedTemplate202005lobbopsbtrnaspen'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBusinessownersStandardsBasedTemplate202005lobbopsbtrnaspen")) {
    check(paused == false) {
