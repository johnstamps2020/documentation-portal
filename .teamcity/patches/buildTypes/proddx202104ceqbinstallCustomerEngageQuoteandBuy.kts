...
To apply the patch, change the buildType with id = 'proddx202104ceqbinstallCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceqbinstallCustomerEngageQuoteandBuy")) {
    params {
        expect {
