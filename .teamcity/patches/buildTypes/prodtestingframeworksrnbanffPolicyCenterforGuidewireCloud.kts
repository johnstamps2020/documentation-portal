...
To apply the patch, change the buildType with id = 'prodtestingframeworksrnbanffPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksrnbanffPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
