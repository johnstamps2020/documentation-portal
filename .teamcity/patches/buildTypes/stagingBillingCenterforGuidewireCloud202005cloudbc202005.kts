    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/2020.05
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/bc/2020.05/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/2020.05/
            """.trimIndent()
        }
    }
    steps {
