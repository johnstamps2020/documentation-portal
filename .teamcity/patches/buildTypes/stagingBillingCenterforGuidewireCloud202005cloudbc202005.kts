...
To apply the patch, change the buildType with id = 'stagingBillingCenterforGuidewireCloud202005cloudbc202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenterforGuidewireCloud202005cloudbc202005")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/bc/2020.05/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras/ReleaseNotes-files/bc/2020.05 --delete
            """.trimIndent()
        }
    }
    steps {
        check(stepsOrder == arrayListOf("BUILD_OUTPUT", "UPLOAD_GENERATED_CONTENT", "COPY_RESOURCES0", "BUILD_CRAWLER_DOCKER_IMAGE", "CRAWL_DOC")) {
            "Unexpected build steps order: $stepsOrder"
        }
        stepsOrder = arrayListOf("BUILD_OUTPUT", "UPLOAD_GENERATED_CONTENT", "COPY_RESOURCES0", "CRAWL_DOC")
    }
}
