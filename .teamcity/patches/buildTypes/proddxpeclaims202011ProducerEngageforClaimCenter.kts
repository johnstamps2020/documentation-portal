...
To apply the patch, change the buildType with id = 'proddxpeclaims202011ProducerEngageforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxpeclaims202011ProducerEngageforClaimCenter")) {
    check(paused == false) {
