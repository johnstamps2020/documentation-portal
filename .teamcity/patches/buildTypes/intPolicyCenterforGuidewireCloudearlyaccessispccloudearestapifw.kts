...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudearlyaccessispccloudearestapifw'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudearlyaccessispccloudearestapifw")) {
    check(paused == false) {
