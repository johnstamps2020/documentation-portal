...
To apply the patch, change the buildType with id = 'proddx202104ceclaimsrefguidesCustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceclaimsrefguidesCustomerEngageAccountManagementforClaimCenter")) {
    params {
        expect {
