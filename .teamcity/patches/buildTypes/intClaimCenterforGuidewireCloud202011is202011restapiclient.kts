...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202011is202011restapiclient'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202011is202011restapiclient")) {
    params {
        expect {
