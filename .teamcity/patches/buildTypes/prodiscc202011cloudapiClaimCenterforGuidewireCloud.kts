...
To apply the patch, change the buildType with id = 'prodiscc202011cloudapiClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011cloudapiClaimCenterforGuidewireCloud")) {
    check(paused == false) {
