...
To apply the patch, change the buildType with id = 'prodispc202011rulesPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011rulesPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
