...
To apply the patch, change the buildType with id = 'prodisbc202104releasenotesBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104releasenotesBillingCenterforGuidewireCloud")) {
    params {
        expect {
