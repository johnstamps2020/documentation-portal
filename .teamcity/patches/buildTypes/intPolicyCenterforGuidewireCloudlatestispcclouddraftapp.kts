...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudlatestispcclouddraftapp'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudlatestispcclouddraftapp")) {
    check(paused == false) {
