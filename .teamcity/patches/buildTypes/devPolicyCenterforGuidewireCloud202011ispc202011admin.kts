...
To apply the patch, change the buildType with id = 'devPolicyCenterforGuidewireCloud202011ispc202011admin'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenterforGuidewireCloud202011ispc202011admin")) {
    check(paused == false) {
