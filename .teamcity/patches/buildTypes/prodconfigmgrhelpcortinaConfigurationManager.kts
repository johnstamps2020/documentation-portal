...
To apply the patch, change the buildType with id = 'prodconfigmgrhelpcortinaConfigurationManager'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodconfigmgrhelpcortinaConfigurationManager")) {
    params {
        expect {
