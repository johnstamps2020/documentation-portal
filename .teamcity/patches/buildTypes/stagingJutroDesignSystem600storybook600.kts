...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem600storybook600'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem600storybook600")) {
    expectSteps {
        script {
