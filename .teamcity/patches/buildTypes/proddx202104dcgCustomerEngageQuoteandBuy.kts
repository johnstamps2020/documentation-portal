...
To apply the patch, change the buildType with id = 'proddx202104dcgCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104dcgCustomerEngageQuoteandBuy")) {
    check(paused == false) {
