...
To apply the patch, change the buildType with id = 'devCustomerEngageAccountManagement202011dxceam202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCustomerEngageAccountManagement202011dxceam202011")) {
    params {
        expect {
