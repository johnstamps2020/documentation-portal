...
To apply the patch, change the buildType with id = 'proddxvodonprem320GuidewireforSalesforceViewonDemand'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodonprem320GuidewireforSalesforceViewonDemand")) {
    check(paused == false) {
