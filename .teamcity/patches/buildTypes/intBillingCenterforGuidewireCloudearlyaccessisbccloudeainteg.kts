...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudearlyaccessisbccloudeainteg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudearlyaccessisbccloudeainteg")) {
    check(paused == false) {
