...
To apply the patch, change the buildType with id = 'prodispc202104testingPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104testingPolicyCenterforGuidewireCloud")) {
    params {
        expect {
