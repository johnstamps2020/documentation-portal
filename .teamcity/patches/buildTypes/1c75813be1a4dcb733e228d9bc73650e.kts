...
To apply the patch, change the buildType with id = '1c75813be1a4dcb733e228d9bc73650e'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("1c75813be1a4dcb733e228d9bc73650e")) {
    check(paused == false) {
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/cc/202209/global --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="iscc202209global"
            ...
            scriptContent = """
                ...
                curl -O https://stash.guidewire.com/rest/api/1.0/projects/DOCSOURCES/repos/common-gw/raw/ditavals/IS-CC-Cloud-Release.ditaval \
                    ...
                    -H "Authorization: Bearer %env.BITBUCKET_ACCESS_TOKEN%"
                                ...
                                dita -i "%teamcity.build.checkoutDir%/GlobalizationGuide.ditamap" -o "%teamcity.build.checkoutDir%/out" --processing-mode "strict" --filter "%teamcity.build.checkoutDir%/common_gw_ditavals/IS-CC-Cloud-Release.ditaval" --gw-base-url "cloud/cc/202209/global" --gw-doc-id "iscc202209global" --gw-doc-title "Globalization" --generate.build.data "yes" --git.url "ssh://git@stash.guidewire.com/docsources/insurancesuite.git" --git.branch "release/2022.09.0" -f "html5-Guidewire" --args.rellinks "nofamily" --build.pdfs "yes" --create-index-redirect "yes" || EXIT_CODE=${'$'}?
