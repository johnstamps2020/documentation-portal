...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceDataIntegrations310dxdionprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceDataIntegrations310dxdionprem310")) {
    params {
        expect {
