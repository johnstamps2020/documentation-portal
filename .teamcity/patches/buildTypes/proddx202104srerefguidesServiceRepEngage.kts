...
To apply the patch, change the buildType with id = 'proddx202104srerefguidesServiceRepEngage'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104srerefguidesServiceRepEngage")) {
    check(paused == false) {
