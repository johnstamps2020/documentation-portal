...
To apply the patch, change the buildType with id = 'proddhclouddataspeccortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhclouddataspeccortinaDataHubforGuidewireCloud")) {
    check(paused == false) {
