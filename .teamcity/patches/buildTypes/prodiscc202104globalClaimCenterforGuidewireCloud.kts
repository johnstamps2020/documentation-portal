...
To apply the patch, change the buildType with id = 'prodiscc202104globalClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104globalClaimCenterforGuidewireCloud")) {
    params {
        expect {
