...
To apply the patch, change the buildType with id = 'intGuidewireCloudConsolelatestguidewirecloudconsolerootinsurerdev'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireCloudConsolelatestguidewirecloudconsolerootinsurerdev")) {
    check(paused == false) {
