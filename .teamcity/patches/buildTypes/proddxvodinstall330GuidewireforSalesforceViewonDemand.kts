...
To apply the patch, change the buildType with id = 'proddxvodinstall330GuidewireforSalesforceViewonDemand'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodinstall330GuidewireforSalesforceViewonDemand")) {
    check(paused == false) {
