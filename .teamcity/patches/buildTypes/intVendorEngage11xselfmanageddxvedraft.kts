...
To apply the patch, change the buildType with id = 'intVendorEngage11xselfmanageddxvedraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intVendorEngage11xselfmanageddxvedraft")) {
    params {
        expect {
