...
To apply the patch, change the buildType with id = 'prodselfmanagedccupgradeguide1011ClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedccupgradeguide1011ClaimCenter")) {
    check(paused == false) {
