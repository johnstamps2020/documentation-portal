...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xExternalAudiencelatestin20211xstudiodraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xExternalAudiencelatestin20211xstudiodraft")) {
    params {
        expect {
