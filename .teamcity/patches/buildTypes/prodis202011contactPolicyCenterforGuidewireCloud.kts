...
To apply the patch, change the buildType with id = 'prodis202011contactPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011contactPolicyCenterforGuidewireCloud")) {
    params {
        expect {
