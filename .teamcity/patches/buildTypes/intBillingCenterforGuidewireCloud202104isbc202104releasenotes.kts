...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloud202104isbc202104releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloud202104isbc202104releasenotes")) {
    expectSteps {
        script {
