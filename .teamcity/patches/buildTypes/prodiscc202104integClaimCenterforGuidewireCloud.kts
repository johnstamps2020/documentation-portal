...
To apply the patch, change the buildType with id = 'prodiscc202104integClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104integClaimCenterforGuidewireCloud")) {
    params {
        expect {
