...
To apply the patch, change the buildType with id = 'prodicclouddevrefcortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodicclouddevrefcortinaInfoCenterforGuidewireCloud")) {
    check(paused == false) {
