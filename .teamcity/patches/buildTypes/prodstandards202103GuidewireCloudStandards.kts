...
To apply the patch, change the buildType with id = 'prodstandards202103GuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandards202103GuidewireCloudStandards")) {
    params {
        expect {
