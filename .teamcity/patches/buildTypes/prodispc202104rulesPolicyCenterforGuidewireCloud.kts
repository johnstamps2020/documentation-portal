...
To apply the patch, change the buildType with id = 'prodispc202104rulesPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104rulesPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
