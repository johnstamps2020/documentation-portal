...
To apply the patch, change the buildType with id = 'proddx202104ceqbappCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceqbappCustomerEngageQuoteandBuy")) {
    params {
        expect {
