...
To apply the patch, change the buildType with id = '0f4855ef8773bcc38a58e0ad5884888d'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("0f4855ef8773bcc38a58e0ad5884888d")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/cc/202209/update --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="iscc202209update"
