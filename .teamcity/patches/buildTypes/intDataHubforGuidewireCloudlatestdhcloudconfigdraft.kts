...
To apply the patch, change the buildType with id = 'intDataHubforGuidewireCloudlatestdhcloudconfigdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDataHubforGuidewireCloudlatestdhcloudconfigdraft")) {
    params {
        expect {
