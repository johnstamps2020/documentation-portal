...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudlatestisclouddraftrestapiclient'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudlatestisclouddraftrestapiclient")) {
    params {
        expect {
