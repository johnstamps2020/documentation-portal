...
To apply the patch, change the buildType with id = 'prodstandards202102GuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandards202102GuidewireCloudStandards")) {
    check(paused == false) {
