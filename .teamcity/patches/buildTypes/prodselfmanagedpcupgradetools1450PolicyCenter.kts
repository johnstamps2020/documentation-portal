...
To apply the patch, change the buildType with id = 'prodselfmanagedpcupgradetools1450PolicyCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedpcupgradetools1450PolicyCenter")) {
    params {
        expect {
