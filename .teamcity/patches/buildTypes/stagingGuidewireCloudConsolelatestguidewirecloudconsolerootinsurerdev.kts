...
To apply the patch, change the buildType with id = 'stagingGuidewireCloudConsolelatestguidewirecloudconsolerootinsurerdev'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireCloudConsolelatestguidewirecloudconsolerootinsurerdev")) {
    params {
        expect {
