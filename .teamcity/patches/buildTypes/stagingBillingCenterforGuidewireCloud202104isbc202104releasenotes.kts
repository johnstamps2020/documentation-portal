...
To apply the patch, change the buildType with id = 'stagingBillingCenterforGuidewireCloud202104isbc202104releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBillingCenterforGuidewireCloud202104isbc202104releasenotes")) {
    check(paused == false) {
