...
To apply the patch, change the buildType with id = 'prodlobcaguideaspenCommercialAutoStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobcaguideaspenCommercialAutoStandardsBasedTemplate")) {
    check(paused == false) {
