...
To apply the patch, change the buildType with id = 'prodispc202104bestpracticePolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104bestpracticePolicyCenterforGuidewireCloud")) {
    check(paused == false) {
