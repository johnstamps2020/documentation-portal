...
To apply the patch, change the buildType with id = 'intCustomerEngageQuoteandBuy11xselfmanageddxceqbdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCustomerEngageQuoteandBuy11xselfmanageddxceqbdraft")) {
    check(paused == false) {
