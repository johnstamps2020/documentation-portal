...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xExternalAudiencelatestin20211xbidraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xExternalAudiencelatestin20211xbidraft")) {
    check(paused == false) {
