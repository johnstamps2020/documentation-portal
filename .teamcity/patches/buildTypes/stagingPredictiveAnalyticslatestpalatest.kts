...
To apply the patch, change the buildType with id = 'stagingPredictiveAnalyticslatestpalatest'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPredictiveAnalyticslatestpalatest")) {
    params {
        expect {
