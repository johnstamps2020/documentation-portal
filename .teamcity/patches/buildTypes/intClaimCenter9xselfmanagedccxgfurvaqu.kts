...
To apply the patch, change the buildType with id = 'intClaimCenter9xselfmanagedccxgfurvaqu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenter9xselfmanagedccxgfurvaqu")) {
    check(paused == false) {
