...
To apply the patch, change the buildType with id = 'proddxceam1120onpremstagingCustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceam1120onpremstagingCustomerEngageAccountManagement")) {
    check(paused == false) {
