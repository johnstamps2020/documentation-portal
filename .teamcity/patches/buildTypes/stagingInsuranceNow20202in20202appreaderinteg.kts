...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20202in20202appreaderinteg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20202in20202appreaderinteg")) {
    params {
        expect {
