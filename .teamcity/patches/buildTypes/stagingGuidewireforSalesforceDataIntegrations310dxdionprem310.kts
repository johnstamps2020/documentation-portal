...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceDataIntegrations310dxdionprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceDataIntegrations310dxdionprem310")) {
    check(paused == false) {
