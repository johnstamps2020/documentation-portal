...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem540storybook540'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem540storybook540")) {
    expectSteps {
        script {
