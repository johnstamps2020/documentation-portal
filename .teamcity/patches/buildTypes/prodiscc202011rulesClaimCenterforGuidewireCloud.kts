...
To apply the patch, change the buildType with id = 'prodiscc202011rulesClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011rulesClaimCenterforGuidewireCloud")) {
    check(paused == false) {
