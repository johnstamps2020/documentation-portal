...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudlatestisbcclouddraftglobal'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudlatestisbcclouddraftglobal")) {
    check(paused == false) {
