...
To apply the patch, change the buildType with id = 'devGuidewireCloudStandards202011standards202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireCloudStandards202011standards202011")) {
    check(paused == false) {
