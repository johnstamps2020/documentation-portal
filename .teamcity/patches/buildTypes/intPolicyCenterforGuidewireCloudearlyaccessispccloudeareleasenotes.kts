...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudearlyaccessispccloudeareleasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudearlyaccessispccloudeareleasenotes")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/pc/2020.11/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras/ReleaseNotes-files/pc/2020.11 --delete
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to S3"
