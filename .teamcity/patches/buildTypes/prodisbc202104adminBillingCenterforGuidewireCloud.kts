...
To apply the patch, change the buildType with id = 'prodisbc202104adminBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104adminBillingCenterforGuidewireCloud")) {
    params {
        expect {
