...
To apply the patch, change the buildType with id = 'prodtestingframeworksuibanffBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksuibanffBillingCenterforGuidewireCloud")) {
    check(paused == false) {
