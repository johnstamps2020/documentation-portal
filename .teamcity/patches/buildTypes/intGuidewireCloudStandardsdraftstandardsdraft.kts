...
To apply the patch, change the buildType with id = 'intGuidewireCloudStandardsdraftstandardsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireCloudStandardsdraftstandardsdraft")) {
    check(paused == false) {
