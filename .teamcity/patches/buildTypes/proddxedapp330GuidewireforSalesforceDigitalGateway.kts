...
To apply the patch, change the buildType with id = 'proddxedapp330GuidewireforSalesforceDigitalGateway'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxedapp330GuidewireforSalesforceDigitalGateway")) {
    params {
        expect {
