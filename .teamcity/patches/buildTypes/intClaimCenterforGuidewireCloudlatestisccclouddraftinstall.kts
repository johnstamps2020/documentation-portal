...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudlatestisccclouddraftinstall'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudlatestisccclouddraftinstall")) {
    check(paused == false) {
