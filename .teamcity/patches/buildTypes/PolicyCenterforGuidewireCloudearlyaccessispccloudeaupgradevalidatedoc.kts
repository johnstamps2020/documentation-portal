    ...
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                jq -n '{"indexForSearch":true,"displayOnLandingPages":true,"metadata":{"product":["PolicyCenter for Guidewire Cloud"],"release":["Dobson"],"subject":["Installation"],"version":["earlyaccess"],"platform":["Cloud"]},"public":false,"environments":["int","staging"],"id":"ispccloudeaupgrade","title":"Upgrade","url":"cloud/pc/ea/upgrade"}' | jq '. += {"gitBuildBranch": "%teamcity.build.vcs.branch.DocumentationTools_DocumentationPortal_isupgradeguidesrc%", "gitSourceId": "isupgradeguidesrc"}' > %env.DOC_INFO%
                cat %env.DOC_INFO%
            """.trimIndent()
        }
    }
