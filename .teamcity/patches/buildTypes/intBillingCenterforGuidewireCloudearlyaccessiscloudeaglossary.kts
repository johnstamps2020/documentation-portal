...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudearlyaccessiscloudeaglossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudearlyaccessiscloudeaglossary")) {
    params {
        expect {
