...
To apply the patch, change the buildType with id = 'prodispc202011globalPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011globalPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
