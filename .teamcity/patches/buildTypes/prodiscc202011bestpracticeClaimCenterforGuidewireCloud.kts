...
To apply the patch, change the buildType with id = 'prodiscc202011bestpracticeClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011bestpracticeClaimCenterforGuidewireCloud")) {
    params {
        expect {
