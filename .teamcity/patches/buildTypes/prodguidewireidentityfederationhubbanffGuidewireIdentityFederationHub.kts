...
To apply the patch, change the buildType with id = 'prodguidewireidentityfederationhubbanffGuidewireIdentityFederationHub'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodguidewireidentityfederationhubbanffGuidewireIdentityFederationHub")) {
    check(paused == false) {
