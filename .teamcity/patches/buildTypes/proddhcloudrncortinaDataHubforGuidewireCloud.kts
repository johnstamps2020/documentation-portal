...
To apply the patch, change the buildType with id = 'proddhcloudrncortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhcloudrncortinaDataHubforGuidewireCloud")) {
    params {
        expect {
