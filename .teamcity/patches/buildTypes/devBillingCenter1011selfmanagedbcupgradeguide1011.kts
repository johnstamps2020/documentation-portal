...
To apply the patch, change the buildType with id = 'devBillingCenter1011selfmanagedbcupgradeguide1011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenter1011selfmanagedbcupgradeguide1011")) {
    params {
        expect {
