...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceViewonDemand310dxvodonprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceViewonDemand310dxvodonprem310")) {
    params {
        expect {
