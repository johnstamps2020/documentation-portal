...
To apply the patch, change the buildType with id = 'devDigitalCodeGenerationExtensionPack202011dxapd202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDigitalCodeGenerationExtensionPack202011dxapd202011")) {
    check(paused == false) {
