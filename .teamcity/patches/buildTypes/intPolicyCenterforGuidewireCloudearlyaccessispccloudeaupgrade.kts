...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloudearlyaccessispccloudeaupgrade'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloudearlyaccessispccloudeaupgrade")) {
    check(paused == false) {
