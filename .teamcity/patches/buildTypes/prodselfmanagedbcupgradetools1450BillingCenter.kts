...
To apply the patch, change the buildType with id = 'prodselfmanagedbcupgradetools1450BillingCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedbcupgradetools1450BillingCenter")) {
    check(paused == false) {
