...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem421storybook421'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem421storybook421")) {
    expectSteps {
        script {
