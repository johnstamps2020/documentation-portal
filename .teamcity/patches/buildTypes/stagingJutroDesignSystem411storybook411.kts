...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem411storybook411'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem411storybook411")) {
    check(paused == false) {
    ...
    steps {
        check(stepsOrder == arrayListOf("BUILD_DOC_SITE_OUTPUT", "BUILD_LOCAL_OUTPUT", "CREATE_ZIP_PACKAGE", "UPLOAD_GENERATED_CONTENT", "CRAWL_DOC")) {
