...
To apply the patch, change the buildType with id = 'prodiccloudbiappcortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudbiappcortinaInfoCenterforGuidewireCloud")) {
    check(paused == false) {
