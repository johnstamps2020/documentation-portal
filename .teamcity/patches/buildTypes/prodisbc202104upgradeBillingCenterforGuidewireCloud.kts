...
To apply the patch, change the buildType with id = 'prodisbc202104upgradeBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104upgradeBillingCenterforGuidewireCloud")) {
    check(paused == false) {
