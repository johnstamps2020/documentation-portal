...
To apply the patch, change the buildType with id = 'proddhclouddevrefcortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhclouddevrefcortinaDataHubforGuidewireCloud")) {
    params {
        expect {
