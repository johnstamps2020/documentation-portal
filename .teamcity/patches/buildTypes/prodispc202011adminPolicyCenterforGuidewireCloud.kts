...
To apply the patch, change the buildType with id = 'prodispc202011adminPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011adminPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
