...
To apply the patch, change the buildType with id = 'prodiscc202011releasenotesClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011releasenotesClaimCenterforGuidewireCloud")) {
    check(paused == false) {
