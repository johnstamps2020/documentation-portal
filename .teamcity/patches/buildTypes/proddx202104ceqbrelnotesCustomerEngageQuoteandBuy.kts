...
To apply the patch, change the buildType with id = 'proddx202104ceqbrelnotesCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceqbrelnotesCustomerEngageQuoteandBuy")) {
    params {
        expect {
