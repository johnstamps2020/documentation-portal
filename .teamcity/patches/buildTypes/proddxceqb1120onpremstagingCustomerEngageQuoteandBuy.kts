...
To apply the patch, change the buildType with id = 'proddxceqb1120onpremstagingCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceqb1120onpremstagingCustomerEngageQuoteandBuy")) {
    params {
        expect {
