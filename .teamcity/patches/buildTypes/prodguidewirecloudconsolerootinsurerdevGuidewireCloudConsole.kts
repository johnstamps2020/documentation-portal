...
To apply the patch, change the buildType with id = 'prodguidewirecloudconsolerootinsurerdevGuidewireCloudConsole'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodguidewirecloudconsolerootinsurerdevGuidewireCloudConsole")) {
    params {
        expect {
