...
To apply the patch, change the buildType with id = 'devInsuranceNow20202in20202appreaderinteg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInsuranceNow20202in20202appreaderinteg")) {
    check(paused == false) {
