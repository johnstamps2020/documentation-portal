...
To apply the patch, change the buildType with id = 'stagingCustomerEngageAccountManagement202008dxceam202008'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCustomerEngageAccountManagement202008dxceam202008")) {
    check(paused == false) {
