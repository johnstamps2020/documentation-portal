...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202011iscc202011upgrade'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202011iscc202011upgrade")) {
    params {
        expect {
