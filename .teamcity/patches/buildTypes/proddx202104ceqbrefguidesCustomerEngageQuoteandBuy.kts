...
To apply the patch, change the buildType with id = 'proddx202104ceqbrefguidesCustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceqbrefguidesCustomerEngageQuoteandBuy")) {
    params {
        expect {
