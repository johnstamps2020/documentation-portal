...
To apply the patch, change the buildType with id = 'intInsuranceNow20201xInternalAudiencelatestin20201xrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20201xInternalAudiencelatestin20201xrndraft")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ChangedFiles/2020.1/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/ReleaseNotes/2020.1.x/ChangedFiles --delete
            """.trimIndent()
        }
    }
    steps {
