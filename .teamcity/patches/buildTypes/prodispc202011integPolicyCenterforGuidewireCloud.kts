...
To apply the patch, change the buildType with id = 'prodispc202011integPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011integPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
