...
To apply the patch, change the buildType with id = 'prodispc202011installPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011installPolicyCenterforGuidewireCloud")) {
    params {
        expect {
