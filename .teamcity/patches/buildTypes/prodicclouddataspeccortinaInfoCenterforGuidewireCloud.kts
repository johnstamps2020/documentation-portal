...
To apply the patch, change the buildType with id = 'prodicclouddataspeccortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodicclouddataspeccortinaInfoCenterforGuidewireCloud")) {
    check(paused == false) {
