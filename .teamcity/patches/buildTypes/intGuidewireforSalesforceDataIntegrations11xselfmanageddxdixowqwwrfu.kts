...
To apply the patch, change the buildType with id = 'intGuidewireforSalesforceDataIntegrations11xselfmanageddxdixowqwwrfu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireforSalesforceDataIntegrations11xselfmanageddxdixowqwwrfu")) {
    check(paused == false) {
