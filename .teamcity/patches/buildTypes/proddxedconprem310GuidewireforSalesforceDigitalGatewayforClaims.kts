...
To apply the patch, change the buildType with id = 'proddxedconprem310GuidewireforSalesforceDigitalGatewayforClaims'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxedconprem310GuidewireforSalesforceDigitalGatewayforClaims")) {
    check(paused == false) {
