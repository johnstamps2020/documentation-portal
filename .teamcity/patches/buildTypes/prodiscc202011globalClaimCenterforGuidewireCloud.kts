...
To apply the patch, change the buildType with id = 'prodiscc202011globalClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011globalClaimCenterforGuidewireCloud")) {
    params {
        expect {
