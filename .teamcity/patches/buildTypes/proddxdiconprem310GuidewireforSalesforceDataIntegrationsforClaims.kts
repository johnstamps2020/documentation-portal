...
To apply the patch, change the buildType with id = 'proddxdiconprem310GuidewireforSalesforceDataIntegrationsforClaims'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdiconprem310GuidewireforSalesforceDataIntegrationsforClaims")) {
    params {
        expect {
