...
To apply the patch, change the buildType with id = 'prodis202011restapiclientPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011restapiclientPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
