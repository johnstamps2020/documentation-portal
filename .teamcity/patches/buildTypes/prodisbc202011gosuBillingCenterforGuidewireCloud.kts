...
To apply the patch, change the buildType with id = 'prodisbc202011gosuBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011gosuBillingCenterforGuidewireCloud")) {
    check(paused == false) {
