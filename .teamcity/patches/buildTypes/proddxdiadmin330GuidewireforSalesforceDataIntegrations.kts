...
To apply the patch, change the buildType with id = 'proddxdiadmin330GuidewireforSalesforceDataIntegrations'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdiadmin330GuidewireforSalesforceDataIntegrations")) {
    params {
        expect {
