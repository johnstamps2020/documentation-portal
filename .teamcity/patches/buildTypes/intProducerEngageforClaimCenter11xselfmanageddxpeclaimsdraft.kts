...
To apply the patch, change the buildType with id = 'intProducerEngageforClaimCenter11xselfmanageddxpeclaimsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intProducerEngageforClaimCenter11xselfmanageddxpeclaimsdraft")) {
    params {
        expect {
