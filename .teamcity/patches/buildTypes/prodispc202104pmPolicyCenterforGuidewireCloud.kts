...
To apply the patch, change the buildType with id = 'prodispc202104pmPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104pmPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
