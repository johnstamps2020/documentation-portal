...
To apply the patch, change the buildType with id = 'devBillingCenterforGuidewireCloud202011isbc202011bestpractice'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devBillingCenterforGuidewireCloud202011isbc202011bestpractice")) {
    check(paused == false) {
