...
To apply the patch, change the buildType with id = 'prodispc202104appPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104appPolicyCenterforGuidewireCloud")) {
    params {
        expect {
