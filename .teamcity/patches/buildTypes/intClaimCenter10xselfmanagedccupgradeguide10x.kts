...
To apply the patch, change the buildType with id = 'intClaimCenter10xselfmanagedccupgradeguide10x'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenter10xselfmanagedccupgradeguide10x")) {
    params {
        expect {
