...
To apply the patch, change the buildType with id = 'devJutroDesignSystem531LTSstorybook531'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devJutroDesignSystem531LTSstorybook531")) {
    expectSteps {
        script {
