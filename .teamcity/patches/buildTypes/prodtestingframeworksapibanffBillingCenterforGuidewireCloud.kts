...
To apply the patch, change the buildType with id = 'prodtestingframeworksapibanffBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksapibanffBillingCenterforGuidewireCloud")) {
    check(paused == false) {
