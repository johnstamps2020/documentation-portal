...
To apply the patch, change the buildType with id = 'intDataHubforGuidewireCloudlatestdhcloudupgradedraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDataHubforGuidewireCloudlatestdhcloudupgradedraft")) {
    check(paused == false) {
