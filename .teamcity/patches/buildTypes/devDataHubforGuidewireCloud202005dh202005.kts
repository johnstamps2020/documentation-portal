...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202005dh202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202005dh202005")) {
    check(paused == false) {
