...
To apply the patch, change the buildType with id = 'stagingDataHubforGuidewireCloud202104dhcloudconfigcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDataHubforGuidewireCloud202104dhcloudconfigcortina")) {
    params {
        expect {
