    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/releasenotes/ReleaseNotes-files/cc/10.x
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cc/10.x/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/releasenotes/ReleaseNotes-files/cc/10.x/
            """.trimIndent()
        }
    }
    steps {
