...
To apply the patch, change the buildType with id = 'stagingClaimCenter1010cc1010staging'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingClaimCenter1010cc1010staging")) {
    check(paused == false) {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cc/10.x/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/releasenotes/ReleaseNotes-files/cc/10.x --delete
            """.trimIndent()
        }
    }
    steps {
