...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202011dh202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202011dh202011")) {
    check(paused == false) {
