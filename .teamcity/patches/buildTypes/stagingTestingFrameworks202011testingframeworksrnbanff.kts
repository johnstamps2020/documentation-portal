...
To apply the patch, change the buildType with id = 'stagingTestingFrameworks202011testingframeworksrnbanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingTestingFrameworks202011testingframeworksrnbanff")) {
    check(paused == false) {
