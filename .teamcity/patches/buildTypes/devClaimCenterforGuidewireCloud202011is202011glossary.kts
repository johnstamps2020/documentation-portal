...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202011is202011glossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202011is202011glossary")) {
    params {
        expect {
