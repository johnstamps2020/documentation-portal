...
To apply the patch, change the buildType with id = 'proddxapd202005DigitalCodeGenerationExtensionPack'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxapd202005DigitalCodeGenerationExtensionPack")) {
    params {
        expect {
