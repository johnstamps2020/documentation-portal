...
To apply the patch, change the buildType with id = 'intJutroDesignSystem531LTSstorybook531'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intJutroDesignSystem531LTSstorybook531")) {
    expectSteps {
        script {
