...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem531LTSstorybook531'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem531LTSstorybook531")) {
    check(paused == false) {
