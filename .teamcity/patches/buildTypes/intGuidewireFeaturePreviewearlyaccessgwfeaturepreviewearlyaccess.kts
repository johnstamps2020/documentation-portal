...
To apply the patch, change the buildType with id = 'intGuidewireFeaturePreviewearlyaccessgwfeaturepreviewearlyaccess'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireFeaturePreviewearlyaccessgwfeaturepreviewearlyaccess")) {
    params {
        expect {
