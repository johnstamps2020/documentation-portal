...
To apply the patch, change the buildType with id = 'intJutroDesignSystemlatestjutrohackathon'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intJutroDesignSystemlatestjutrohackathon")) {
    expectSteps {
        script {
    ...
    steps {
        check(stepsOrder == arrayListOf("BUILD_DOC_SITE_OUTPUT", "UPLOAD_GENERATED_CONTENT")) {
