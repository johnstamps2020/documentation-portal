...
To apply the patch, change the buildType with id = 'stagingDataHubforGuidewireCloud202005dh202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingDataHubforGuidewireCloud202005dh202005")) {
    check(paused == false) {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/Aspen-10.3/DataHub/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras --delete
            """.trimIndent()
        }
    }
    steps {
