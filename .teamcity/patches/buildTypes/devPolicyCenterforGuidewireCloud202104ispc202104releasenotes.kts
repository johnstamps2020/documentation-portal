...
To apply the patch, change the buildType with id = 'devPolicyCenterforGuidewireCloud202104ispc202104releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenterforGuidewireCloud202104ispc202104releasenotes")) {
    expectSteps {
        script {
