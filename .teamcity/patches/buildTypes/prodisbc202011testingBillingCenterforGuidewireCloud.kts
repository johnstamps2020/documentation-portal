...
To apply the patch, change the buildType with id = 'prodisbc202011testingBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011testingBillingCenterforGuidewireCloud")) {
    params {
        expect {
