...
To apply the patch, change the buildType with id = 'prodlobglguideaspenGeneralLiabilityStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobglguideaspenGeneralLiabilityStandardsBasedTemplate")) {
    check(paused == false) {
