...
To apply the patch, change the buildType with id = 'prodiscc202011integClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011integClaimCenterforGuidewireCloud")) {
    check(paused == false) {
