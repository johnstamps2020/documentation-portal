...
To apply the patch, change the buildType with id = 'prodic202005InfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodic202005InfoCenterforGuidewireCloud")) {
    params {
        expect {
