...
To apply the patch, change the buildType with id = 'devPolicyCenterforGuidewireCloud202104pc202104apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenterforGuidewireCloud202104pc202104apiref")) {
    expectSteps {
        script {
