...
To apply the patch, change the buildType with id = 'prodiscc202104rulesClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104rulesClaimCenterforGuidewireCloud")) {
    params {
        expect {
