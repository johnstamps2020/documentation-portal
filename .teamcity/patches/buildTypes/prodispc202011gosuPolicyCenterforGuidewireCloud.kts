...
To apply the patch, change the buildType with id = 'prodispc202011gosuPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202011gosuPolicyCenterforGuidewireCloud")) {
    params {
        expect {
