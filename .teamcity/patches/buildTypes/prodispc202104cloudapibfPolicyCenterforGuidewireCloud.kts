...
To apply the patch, change the buildType with id = 'prodispc202104cloudapibfPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104cloudapibfPolicyCenterforGuidewireCloud")) {
    params {
        expect {
