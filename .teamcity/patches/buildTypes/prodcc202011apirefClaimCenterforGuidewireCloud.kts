...
To apply the patch, change the buildType with id = 'prodcc202011apirefClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodcc202011apirefClaimCenterforGuidewireCloud")) {
    check(paused == false) {
