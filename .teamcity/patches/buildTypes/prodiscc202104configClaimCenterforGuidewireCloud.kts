...
To apply the patch, change the buildType with id = 'prodiscc202104configClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202104configClaimCenterforGuidewireCloud")) {
    params {
        expect {
