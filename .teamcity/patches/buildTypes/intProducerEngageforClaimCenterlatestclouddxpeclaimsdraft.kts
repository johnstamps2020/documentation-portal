...
To apply the patch, change the buildType with id = 'intProducerEngageforClaimCenterlatestclouddxpeclaimsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intProducerEngageforClaimCenterlatestclouddxpeclaimsdraft")) {
    check(paused == false) {
