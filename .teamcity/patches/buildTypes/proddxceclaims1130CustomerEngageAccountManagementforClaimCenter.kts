...
To apply the patch, change the buildType with id = 'proddxceclaims1130CustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceclaims1130CustomerEngageAccountManagementforClaimCenter")) {
    check(paused == false) {
