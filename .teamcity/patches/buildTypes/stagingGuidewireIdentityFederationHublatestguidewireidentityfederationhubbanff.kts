...
To apply the patch, change the buildType with id = 'stagingGuidewireIdentityFederationHublatestguidewireidentityfederationhubbanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireIdentityFederationHublatestguidewireidentityfederationhubbanff")) {
    check(paused == false) {
