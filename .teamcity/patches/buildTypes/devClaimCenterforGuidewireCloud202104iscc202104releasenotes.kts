...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202104iscc202104releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202104iscc202104releasenotes")) {
    check(paused == false) {
