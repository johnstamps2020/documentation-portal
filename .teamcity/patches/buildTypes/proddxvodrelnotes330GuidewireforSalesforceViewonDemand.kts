...
To apply the patch, change the buildType with id = 'proddxvodrelnotes330GuidewireforSalesforceViewonDemand'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodrelnotes330GuidewireforSalesforceViewonDemand")) {
    params {
        expect {
