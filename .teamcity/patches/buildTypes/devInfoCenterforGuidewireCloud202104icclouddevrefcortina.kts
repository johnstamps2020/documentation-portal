...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202104icclouddevrefcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202104icclouddevrefcortina")) {
    check(paused == false) {
