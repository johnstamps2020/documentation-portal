...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20202in20202portaldev'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20202in20202portaldev")) {
    params {
        expect {
