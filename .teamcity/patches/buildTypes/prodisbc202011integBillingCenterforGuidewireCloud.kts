...
To apply the patch, change the buildType with id = 'prodisbc202011integBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011integBillingCenterforGuidewireCloud")) {
    check(paused == false) {
