        ...
        insert(0) {
            script {
                ...
                scriptContent = """
                    ...
                    npm-cli-login -u sys-doc@guidewire.com -p %env.ARTIFACTORY_PASSWORD% -e doctools@guidewire.com -r https://artifactory.guidewire.com/api/npm/jutro-suite-npm-dev
                    npm config set registry https://artifactory.guidewire.com/api/npm/jutro-suite-npm-dev/
                    
                    # Doctools repo
                    npm-cli-login -u sys-doc@guidewire.com -p %env.ARTIFACTORY_PASSWORD% -e doctools@guidewire.com -r https://artifactory.guidewire.com/api/npm/doctools-npm-dev -s @doctools
