...
To apply the patch, change the buildType with id = 'stagingCustomerEngageQuoteandBuy202010dxceqb202010'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCustomerEngageQuoteandBuy202010dxceqb202010")) {
    check(paused == false) {
