...
To apply the patch, change the buildType with id = 'proddxpe1120onpremstagingProducerEngage'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxpe1120onpremstagingProducerEngage")) {
    check(paused == false) {
