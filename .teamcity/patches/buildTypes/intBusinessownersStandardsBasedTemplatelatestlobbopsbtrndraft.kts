...
To apply the patch, change the buildType with id = 'intBusinessownersStandardsBasedTemplatelatestlobbopsbtrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBusinessownersStandardsBasedTemplatelatestlobbopsbtrndraft")) {
    params {
        expect {
