...
To apply the patch, change the buildType with id = 'stagingPolicyCenterforGuidewireCloud202005cloudpc202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenterforGuidewireCloud202005cloudpc202005")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/pc/2020.05/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras/ReleaseNotes-files/pc/2020.05 --delete
            """.trimIndent()
        }
    }
    steps {
