...
To apply the patch, change the buildType with id = 'devInfoCenterforGuidewireCloud202104iccloudconfigcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devInfoCenterforGuidewireCloud202104iccloudconfigcortina")) {
    check(paused == false) {
