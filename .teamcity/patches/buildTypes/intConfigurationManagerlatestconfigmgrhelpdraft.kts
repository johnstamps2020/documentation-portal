...
To apply the patch, change the buildType with id = 'intConfigurationManagerlatestconfigmgrhelpdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intConfigurationManagerlatestconfigmgrhelpdraft")) {
    check(paused == false) {
