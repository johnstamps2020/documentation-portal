...
To apply the patch, change the buildType with id = 'stagingCloudDataAccessBanffclouddataaccessbanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCloudDataAccessBanffclouddataaccessbanff")) {
    params {
        expect {
