...
To apply the patch, change the buildType with id = 'stagingClaimCenterforGuidewireCloud202011iscc202011integ'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingClaimCenterforGuidewireCloud202011iscc202011integ")) {
    params {
        expect {
