...
To apply the patch, change the buildType with id = 'prodiscc202011upgradeClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiscc202011upgradeClaimCenterforGuidewireCloud")) {
    params {
        expect {
