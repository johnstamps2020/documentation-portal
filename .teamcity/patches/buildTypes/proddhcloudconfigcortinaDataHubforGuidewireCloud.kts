...
To apply the patch, change the buildType with id = 'proddhcloudconfigcortinaDataHubforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddhcloudconfigcortinaDataHubforGuidewireCloud")) {
    params {
        expect {
