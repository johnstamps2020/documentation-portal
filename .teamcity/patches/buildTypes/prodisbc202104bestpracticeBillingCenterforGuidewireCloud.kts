...
To apply the patch, change the buildType with id = 'prodisbc202104bestpracticeBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104bestpracticeBillingCenterforGuidewireCloud")) {
    params {
        expect {
