...
To apply the patch, change the buildType with id = 'devClaimCenterforGuidewireCloud202011iscc202011testing'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devClaimCenterforGuidewireCloud202011iscc202011testing")) {
    check(paused == false) {
