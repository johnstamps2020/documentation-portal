...
To apply the patch, change the buildType with id = 'intCustomerEngageAccountManagementforClaimCenter11xselfmanageddxceclaimsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCustomerEngageAccountManagementforClaimCenter11xselfmanageddxceclaimsdraft")) {
    params {
        expect {
