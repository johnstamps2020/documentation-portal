...
To apply the patch, change the buildType with id = 'devPolicyCenterforGuidewireCloud202011ispc202011gosu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenterforGuidewireCloud202011ispc202011gosu")) {
    check(paused == false) {
