...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xInternalAudiencelatestin20211xclaimsconfigdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xInternalAudiencelatestin20211xclaimsconfigdraft")) {
    check(paused == false) {
