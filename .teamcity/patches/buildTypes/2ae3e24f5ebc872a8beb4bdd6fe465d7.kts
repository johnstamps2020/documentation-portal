...
To apply the patch, change the buildType with id = '2ae3e24f5ebc872a8beb4bdd6fe465d7'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("2ae3e24f5ebc872a8beb4bdd6fe465d7")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/202209/integoverview --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="is202209integoverview"
        ...
        script {
            ...
            scriptContent = """
                ...
                curl -O https://stash.guidewire.com/rest/api/1.0/projects/DOCSOURCES/repos/common-gw/raw/ditavals/GW-Generic-Cloud-Release.ditaval \
                    -H "Accept: application/json" \
                    -H "Authorization: Bearer %env.BITBUCKET_ACCESS_TOKEN%"
                
                                echo "Building output"
                                dita -i "%teamcity.build.checkoutDir%/OverviewCloudIntegration.ditamap" -o "%teamcity.build.checkoutDir%/out" --processing-mode "strict" --filter "%teamcity.build.checkoutDir%/common_gw_ditavals/GW-Generic-Cloud-Release.ditaval" --gw-base-url "cloud/202209/integoverview" --gw-doc-id "is202209integoverview" --gw-doc-title "Overview of Cloud Integration" --generate.build.data "yes" --git.url "ssh://git@stash.guidewire.com/docsources/insurancesuite.git" --git.branch "release/2022.09.0" -f "html5-Guidewire" --args.rellinks "nofamily" --build.pdfs "yes" --create-index-redirect "yes" || EXIT_CODE=${'$'}?
