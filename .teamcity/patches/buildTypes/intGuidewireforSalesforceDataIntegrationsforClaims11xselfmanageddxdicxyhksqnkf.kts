...
To apply the patch, change the buildType with id = 'intGuidewireforSalesforceDataIntegrationsforClaims11xselfmanageddxdicxyhksqnkf'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intGuidewireforSalesforceDataIntegrationsforClaims11xselfmanageddxdicxyhksqnkf")) {
    params {
        expect {
