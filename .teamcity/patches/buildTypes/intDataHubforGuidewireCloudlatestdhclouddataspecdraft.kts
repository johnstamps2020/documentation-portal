...
To apply the patch, change the buildType with id = 'intDataHubforGuidewireCloudlatestdhclouddataspecdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intDataHubforGuidewireCloudlatestdhclouddataspecdraft")) {
    check(paused == false) {
