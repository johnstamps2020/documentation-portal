...
To apply the patch, change the buildType with id = 'prodiccloudinstallcortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudinstallcortinaInfoCenterforGuidewireCloud")) {
    params {
        expect {
