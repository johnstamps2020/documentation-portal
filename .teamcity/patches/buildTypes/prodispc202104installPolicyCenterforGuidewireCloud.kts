...
To apply the patch, change the buildType with id = 'prodispc202104installPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104installPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
