...
To apply the patch, change the buildType with id = 'devCustomerEngageAccountManagementforClaimCenter202011dxceclaims202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCustomerEngageAccountManagementforClaimCenter202011dxceclaims202011")) {
    params {
        expect {
