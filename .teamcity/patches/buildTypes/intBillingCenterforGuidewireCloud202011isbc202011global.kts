...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloud202011isbc202011global'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloud202011isbc202011global")) {
    params {
        expect {
