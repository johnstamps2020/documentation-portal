...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudearlyaccessisbccloudeaapp'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudearlyaccessisbccloudeaapp")) {
    params {
        expect {
