...
To apply the patch, change the buildType with id = 'stagingClaimCenterforGuidewireCloud202005cloudcc202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingClaimCenterforGuidewireCloud202005cloudcc202005")) {
    check(paused == false) {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cc/2020.05/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras/ReleaseNotes-files/cc/2020.05 --delete
            """.trimIndent()
        }
    }
    steps {
