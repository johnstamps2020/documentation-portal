...
To apply the patch, change the buildType with id = 'proddx202104ceaminstallCustomerEngageAccountManagement'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceaminstallCustomerEngageAccountManagement")) {
    params {
        expect {
