...
To apply the patch, change the buildType with id = 'proddxedonprem320GuidewireforSalesforceDigitalGateway'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxedonprem320GuidewireforSalesforceDigitalGateway")) {
    params {
        expect {
