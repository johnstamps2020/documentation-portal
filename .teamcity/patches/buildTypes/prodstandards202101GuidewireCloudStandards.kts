...
To apply the patch, change the buildType with id = 'prodstandards202101GuidewireCloudStandards'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodstandards202101GuidewireCloudStandards")) {
    params {
        expect {
