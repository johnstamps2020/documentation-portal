...
To apply the patch, change the buildType with id = 'stagingCloudDataAccessAspenclouddataaccessaspen'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingCloudDataAccessAspenclouddataaccessaspen")) {
    check(paused == false) {
