...
To apply the patch, change the buildType with id = 'prodselfmanagedbcfxhglseuBillingCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodselfmanagedbcfxhglseuBillingCenter")) {
    check(paused == false) {
