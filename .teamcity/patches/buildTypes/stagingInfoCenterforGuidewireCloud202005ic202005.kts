...
To apply the patch, change the buildType with id = 'stagingInfoCenterforGuidewireCloud202005ic202005'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInfoCenterforGuidewireCloud202005ic202005")) {
    params {
        expect {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/Aspen-10.3/InfoCenter/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras --delete
            """.trimIndent()
        }
    }
    steps {
