...
To apply the patch, change the buildType with id = 'proddx202104srerelnotesServiceRepEngage'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104srerelnotesServiceRepEngage")) {
    check(paused == false) {
