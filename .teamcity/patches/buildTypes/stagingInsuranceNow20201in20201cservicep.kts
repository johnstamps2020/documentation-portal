...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20201in20201cservicep'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20201in20201cservicep")) {
    check(paused == false) {
