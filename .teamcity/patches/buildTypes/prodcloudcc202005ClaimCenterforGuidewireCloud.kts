...
To apply the patch, change the buildType with id = 'prodcloudcc202005ClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodcloudcc202005ClaimCenterforGuidewireCloud")) {
    params {
        expect {
