...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceDataIntegrations320dxdionprem320'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceDataIntegrations320dxdionprem320")) {
    check(paused == false) {
