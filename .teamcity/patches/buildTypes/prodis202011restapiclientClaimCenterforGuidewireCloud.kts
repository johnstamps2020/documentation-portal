...
To apply the patch, change the buildType with id = 'prodis202011restapiclientClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011restapiclientClaimCenterforGuidewireCloud")) {
    params {
        expect {
