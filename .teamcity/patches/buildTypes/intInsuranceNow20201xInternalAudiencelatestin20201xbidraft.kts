...
To apply the patch, change the buildType with id = 'intInsuranceNow20201xInternalAudiencelatestin20201xbidraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20201xInternalAudiencelatestin20201xbidraft")) {
    params {
        expect {
