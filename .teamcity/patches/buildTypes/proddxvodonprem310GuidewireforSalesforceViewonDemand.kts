...
To apply the patch, change the buildType with id = 'proddxvodonprem310GuidewireforSalesforceViewonDemand'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxvodonprem310GuidewireforSalesforceViewonDemand")) {
    params {
        expect {
