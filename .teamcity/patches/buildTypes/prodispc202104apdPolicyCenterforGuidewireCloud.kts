...
To apply the patch, change the buildType with id = 'prodispc202104apdPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104apdPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
