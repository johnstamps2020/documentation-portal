...
To apply the patch, change the buildType with id = 'intInsuranceNow20202xExternalAudiencelatestincsp323rndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20202xExternalAudiencelatestincsp323rndraft")) {
    check(paused == false) {
