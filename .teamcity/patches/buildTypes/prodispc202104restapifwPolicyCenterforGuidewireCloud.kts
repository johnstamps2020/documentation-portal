...
To apply the patch, change the buildType with id = 'prodispc202104restapifwPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104restapifwPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
