...
To apply the patch, change the buildType with id = 'stagingPolicyCenterforGuidewireCloud202011ispc202011releasenotes'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingPolicyCenterforGuidewireCloud202011ispc202011releasenotes")) {
    check(paused == false) {
