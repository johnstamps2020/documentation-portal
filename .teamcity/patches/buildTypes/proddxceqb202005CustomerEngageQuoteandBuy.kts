...
To apply the patch, change the buildType with id = 'proddxceqb202005CustomerEngageQuoteandBuy'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxceqb202005CustomerEngageQuoteandBuy")) {
    check(paused == false) {
