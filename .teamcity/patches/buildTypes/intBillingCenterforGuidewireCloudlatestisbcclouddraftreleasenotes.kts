    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/2021.04
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/bc/2021.04/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/2021.04/
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to the doc output dir"
            ...
            scriptContent = """
                ...
                echo "Copying files to the doc output dir"
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cm/2021.04
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cm/2021.04/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cm/2021.04/
            """.trimIndent()
        }
    }
    steps {
