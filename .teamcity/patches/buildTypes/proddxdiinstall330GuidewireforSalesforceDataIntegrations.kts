...
To apply the patch, change the buildType with id = 'proddxdiinstall330GuidewireforSalesforceDataIntegrations'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxdiinstall330GuidewireforSalesforceDataIntegrations")) {
    params {
        expect {
