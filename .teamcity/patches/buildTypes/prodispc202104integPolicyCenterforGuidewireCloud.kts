...
To apply the patch, change the buildType with id = 'prodispc202104integPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104integPolicyCenterforGuidewireCloud")) {
    params {
        expect {
