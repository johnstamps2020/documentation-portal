...
To apply the patch, change the buildType with id = 'intInsuranceNow20211xInternalAudiencelatestin20211xuwconfigdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20211xInternalAudiencelatestin20211xuwconfigdraft")) {
    check(paused == false) {
