...
To apply the patch, change the buildType with id = 'stagingBusinessownersStandardsBasedTemplate202011lobbopguidebanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingBusinessownersStandardsBasedTemplate202011lobbopguidebanff")) {
    check(paused == false) {
