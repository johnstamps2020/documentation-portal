...
To apply the patch, change the buildType with id = 'stagingJutroDesignSystem510storybook510'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingJutroDesignSystem510storybook510")) {
    check(paused == false) {
