...
To apply the patch, change the buildType with id = 'proddxedinstall330GuidewireforSalesforceDigitalGateway'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddxedinstall330GuidewireforSalesforceDigitalGateway")) {
    params {
        expect {
