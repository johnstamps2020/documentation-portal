...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202011is202011glossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202011is202011glossary")) {
    params {
        expect {
