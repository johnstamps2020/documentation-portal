...
To apply the patch, change the buildType with id = 'intCommercialAutoStandardsBasedTemplatelatestlobcaguidedraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCommercialAutoStandardsBasedTemplatelatestlobcaguidedraft")) {
    check(paused == false) {
