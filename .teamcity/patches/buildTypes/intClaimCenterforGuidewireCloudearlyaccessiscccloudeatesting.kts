...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudearlyaccessiscccloudeatesting'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudearlyaccessiscccloudeatesting")) {
    params {
        expect {
