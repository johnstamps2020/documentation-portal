...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloudlatestisclouddraftrestapiclient'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloudlatestisclouddraftrestapiclient")) {
    params {
        expect {
