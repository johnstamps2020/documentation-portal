...
To apply the patch, change the buildType with id = 'devPolicyCenter909selfmanagedpcupgradetools1450'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devPolicyCenter909selfmanagedpcupgradetools1450")) {
    params {
        expect {
