...
To apply the patch, change the buildType with id = 'prodispc202104adminPolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104adminPolicyCenterforGuidewireCloud")) {
    check(paused == false) {
