...
To apply the patch, change the buildType with id = 'intCustomerEngageAccountManagementlatestclouddxceamdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCustomerEngageAccountManagementlatestclouddxceamdraft")) {
    check(paused == false) {
