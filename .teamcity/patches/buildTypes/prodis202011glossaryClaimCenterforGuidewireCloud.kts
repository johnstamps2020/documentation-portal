...
To apply the patch, change the buildType with id = 'prodis202011glossaryClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011glossaryClaimCenterforGuidewireCloud")) {
    check(paused == false) {
