...
To apply the patch, change the buildType with id = '0480e89a79ea24d3ecdc2c926eaabfc7'
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/cc/202209/dataarchiving --delete
            """.trimIndent()
        ...
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                export DOC_ID="iscc202209dataarchiving"
