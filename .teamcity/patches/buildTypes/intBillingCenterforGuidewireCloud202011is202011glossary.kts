...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloud202011is202011glossary'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloud202011is202011glossary")) {
    params {
        expect {
