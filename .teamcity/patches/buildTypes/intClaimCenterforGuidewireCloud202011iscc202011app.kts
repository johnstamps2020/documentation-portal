...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202011iscc202011app'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202011iscc202011app")) {
    params {
        expect {
