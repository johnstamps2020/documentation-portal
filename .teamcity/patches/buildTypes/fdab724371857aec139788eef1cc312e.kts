...
To apply the patch, change the buildType with id = 'fdab724371857aec139788eef1cc312e'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("fdab724371857aec139788eef1cc312e")) {
    expectSteps {
        script {
            ...
            scriptContent = """
                ...
                export AWS_REGION="%env.ATMOS_DEV_AWS_DEFAULT_REGION%"
                                ...
                                aws s3 sync "%teamcity.build.checkoutDir%/out" s3://tenant-doctools-staging-builds/cloud/pc/202302/admin --delete
            """.trimIndent()
            ...
            scriptContent = """
                ...
                curl -O https://stash.guidewire.com/rest/api/1.0/projects/DOCSOURCES/repos/common-gw/raw/ditavals/IS-PC-Cloud-Release.ditaval \
                    ...
                    -H "Authorization: Bearer %env.BITBUCKET_ACCESS_TOKEN%"
                                ...
                                dita -i "%teamcity.build.checkoutDir%/AdminGuide.ditamap" -o "%teamcity.build.checkoutDir%/out" --processing-mode "strict" --filter "%teamcity.build.checkoutDir%/common_gw_ditavals/IS-PC-Cloud-Release.ditaval" --gw-base-url "cloud/pc/202302/admin" --gw-doc-id "ispc202302admin" --gw-doc-title "Administration" --generate.build.data "yes" --git.url "ssh://git@stash.guidewire.com/docsources/insurancesuite.git" --git.branch "release/2023.02.0" -f "html5-Guidewire" --args.rellinks "nofamily" --build.pdfs "yes" --create-index-redirect "yes" || EXIT_CODE=${'$'}?
