    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/2020.11
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/bc/2020.11/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/bc/2020.11/
            """.trimIndent()
        }
        script {
            name = "Copy resources from git to the doc output dir"
            ...
            scriptContent = """
                ...
                echo "Copying files to the doc output dir"
                mkdir -p %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cm/2020.11
                cp -R ./${'$'}RESOURCE_DIR/ReleaseNotes-files/cm/2020.11/* %env.WORKING_DIR%/%env.OUTPUT_PATH%/extras/ReleaseNotes-files/cm/2020.11/
            """.trimIndent()
        }
    }
    steps {
