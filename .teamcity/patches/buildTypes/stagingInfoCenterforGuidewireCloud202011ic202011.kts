...
To apply the patch, change the buildType with id = 'stagingInfoCenterforGuidewireCloud202011ic202011'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInfoCenterforGuidewireCloud202011ic202011")) {
    check(paused == false) {
    ...
    expectSteps {
        ...
        script {
            ...
            scriptContent = """
                ...
                aws s3 sync ./${'$'}RESOURCE_DIR/Banff-10.4/InfoCenter/ s3://%env.S3_BUCKET_NAME%/%env.PUBLISH_PATH%/extras --delete
            """.trimIndent()
        }
    }
    steps {
