...
To apply the patch, change the buildType with id = 'proddx202104peclaimsdevProducerEngageforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104peclaimsdevProducerEngageforClaimCenter")) {
    check(paused == false) {
