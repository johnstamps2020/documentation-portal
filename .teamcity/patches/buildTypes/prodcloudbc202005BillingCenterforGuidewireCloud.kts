...
To apply the patch, change the buildType with id = 'prodcloudbc202005BillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodcloudbc202005BillingCenterforGuidewireCloud")) {
    check(paused == false) {
