...
To apply the patch, change the buildType with id = 'intPolicyCenterforGuidewireCloud202011ispc202011admin'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intPolicyCenterforGuidewireCloud202011ispc202011admin")) {
    params {
        expect {
