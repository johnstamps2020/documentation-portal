...
To apply the patch, change the buildType with id = 'intClaimCenter10xselfmanagedccxbvqtoakg'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenter10xselfmanagedccxbvqtoakg")) {
    params {
        expect {
