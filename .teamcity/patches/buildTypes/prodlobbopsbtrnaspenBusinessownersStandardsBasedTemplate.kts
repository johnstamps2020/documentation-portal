...
To apply the patch, change the buildType with id = 'prodlobbopsbtrnaspenBusinessownersStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobbopsbtrnaspenBusinessownersStandardsBasedTemplate")) {
    check(paused == false) {
