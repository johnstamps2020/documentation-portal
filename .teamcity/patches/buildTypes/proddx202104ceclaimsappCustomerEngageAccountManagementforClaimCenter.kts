...
To apply the patch, change the buildType with id = 'proddx202104ceclaimsappCustomerEngageAccountManagementforClaimCenter'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("proddx202104ceclaimsappCustomerEngageAccountManagementforClaimCenter")) {
    check(paused == false) {
