...
To apply the patch, change the buildType with id = 'stagingGuidewireforSalesforceViewonDemandforClaims310dxvodconprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingGuidewireforSalesforceViewonDemandforClaims310dxvodconprem310")) {
    check(paused == false) {
