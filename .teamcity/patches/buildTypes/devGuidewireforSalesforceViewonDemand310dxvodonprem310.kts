...
To apply the patch, change the buildType with id = 'devGuidewireforSalesforceViewonDemand310dxvodonprem310'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devGuidewireforSalesforceViewonDemand310dxvodonprem310")) {
    params {
        expect {
