...
To apply the patch, change the buildType with id = 'prodtestingframeworksuicortinaBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodtestingframeworksuicortinaBillingCenterforGuidewireCloud")) {
    check(paused == false) {
