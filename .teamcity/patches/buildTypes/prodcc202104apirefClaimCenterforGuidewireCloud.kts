...
To apply the patch, change the buildType with id = 'prodcc202104apirefClaimCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodcc202104apirefClaimCenterforGuidewireCloud")) {
    params {
        expect {
