...
To apply the patch, change the buildType with id = 'prodiccloudreportscortinaInfoCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodiccloudreportscortinaInfoCenterforGuidewireCloud")) {
    params {
        expect {
