...
To apply the patch, change the buildType with id = 'intInsuranceNow20202xInternalAudiencelatestinupgradetoolsdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intInsuranceNow20202xInternalAudiencelatestinupgradetoolsdraft")) {
    check(paused == false) {
