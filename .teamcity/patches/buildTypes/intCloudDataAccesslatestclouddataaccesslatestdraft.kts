...
To apply the patch, change the buildType with id = 'intCloudDataAccesslatestclouddataaccesslatestdraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intCloudDataAccesslatestclouddataaccesslatestdraft")) {
    check(paused == false) {
