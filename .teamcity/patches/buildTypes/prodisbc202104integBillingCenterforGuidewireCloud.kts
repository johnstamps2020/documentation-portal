...
To apply the patch, change the buildType with id = 'prodisbc202104integBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202104integBillingCenterforGuidewireCloud")) {
    params {
        expect {
