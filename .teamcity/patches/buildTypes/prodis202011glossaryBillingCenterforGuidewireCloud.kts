...
To apply the patch, change the buildType with id = 'prodis202011glossaryBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodis202011glossaryBillingCenterforGuidewireCloud")) {
    check(paused == false) {
