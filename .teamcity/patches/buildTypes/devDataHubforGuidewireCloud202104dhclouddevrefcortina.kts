...
To apply the patch, change the buildType with id = 'devDataHubforGuidewireCloud202104dhclouddevrefcortina'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devDataHubforGuidewireCloud202104dhclouddevrefcortina")) {
    check(paused == false) {
