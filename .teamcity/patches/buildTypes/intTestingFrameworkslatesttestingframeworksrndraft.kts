...
To apply the patch, change the buildType with id = 'intTestingFrameworkslatesttestingframeworksrndraft'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intTestingFrameworkslatesttestingframeworksrndraft")) {
    params {
        expect {
