...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudlatestisbcclouddraftapp'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudlatestisbcclouddraftapp")) {
    check(paused == false) {
