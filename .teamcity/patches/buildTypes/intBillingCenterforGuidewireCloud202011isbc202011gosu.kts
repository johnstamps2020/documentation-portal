...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloud202011isbc202011gosu'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloud202011isbc202011gosu")) {
    params {
        expect {
