...
To apply the patch, change the buildType with id = 'prodispc202104upgradePolicyCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodispc202104upgradePolicyCenterforGuidewireCloud")) {
    check(paused == false) {
