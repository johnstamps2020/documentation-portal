...
To apply the patch, change the buildType with id = 'stagingInsuranceNow20211in20211csp323rn'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("stagingInsuranceNow20211in20211csp323rn")) {
    check(paused == false) {
