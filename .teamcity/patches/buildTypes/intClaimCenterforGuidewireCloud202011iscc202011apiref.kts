...
To apply the patch, change the buildType with id = 'intClaimCenterforGuidewireCloud202011iscc202011apiref'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intClaimCenterforGuidewireCloud202011iscc202011apiref")) {
    check(paused == false) {
