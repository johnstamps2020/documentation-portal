...
To apply the patch, change the buildType with id = 'prodisbc202011upgradeBillingCenterforGuidewireCloud'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodisbc202011upgradeBillingCenterforGuidewireCloud")) {
    check(paused == false) {
