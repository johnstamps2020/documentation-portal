...
To apply the patch, change the buildType with id = 'devCloudDataAccessBanffclouddataaccessbanff'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("devCloudDataAccessBanffclouddataaccessbanff")) {
    params {
        expect {
