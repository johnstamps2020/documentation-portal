...
To apply the patch, change the buildType with id = 'intBillingCenterforGuidewireCloudearlyaccessisbccloudeaconfig'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("intBillingCenterforGuidewireCloudearlyaccessisbccloudeaconfig")) {
    check(paused == false) {
