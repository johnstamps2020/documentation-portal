...
To apply the patch, change the buildType with id = 'prodlobcasbtrnaspenCommercialAutoStandardsBasedTemplate'
accordingly, and delete the patch script.
*/
changeBuildType(RelativeId("prodlobcasbtrnaspenCommercialAutoStandardsBasedTemplate")) {
    check(paused == false) {
