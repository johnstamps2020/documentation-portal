...
object DeployDev : BuildType({
    ...
    params {
        ...
        param("env.PARTNERS_LOGIN_URL", "https://qaint-guidewire.cs170.force.com/partners/idp/endpoint/HttpRedirect")
        param("env.CUSTOMERS_LOGIN_URL", "https://qaint-guidewire.cs170.force.com/customers/idp/endpoint/HttpRedirect")
    }
...
object DeployStaging : BuildType({
    ...
    params {
        ...
        param("env.PARTNERS_LOGIN_URL", "https://uat-guidewire.cs218.force.com/partners/idp/endpoint/HttpRedirect")
        param("env.CUSTOMERS_LOGIN_URL", "https://uat-guidewire.cs218.force.com/customers/idp/endpoint/HttpRedirect")
    }
