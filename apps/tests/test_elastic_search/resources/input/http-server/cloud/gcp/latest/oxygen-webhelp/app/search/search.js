define(['util', 'options', 'test_elastic_search/resources/input/http-server/cloud/gcp/latest/oxygen-webhelp/app/search/nwSearchFnt', 'searchHistoryItems', 'localization', 'jquery', 'jquery.highlight', 'jquery.bootpag'], function(util, options, nwSearchFnt, searchHistory, i18n, $) {
