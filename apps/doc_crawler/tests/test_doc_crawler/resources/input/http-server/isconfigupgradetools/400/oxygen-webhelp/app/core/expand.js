define(["options", "localization", "jquery"], function (options, i18n, $) {
    ...
    var selectors = {
        ...
        "expand_buttons": [
            ...
            /* "table > caption", */
            /* Article title */
            /* ".topic > .title", */ /* DOCS-419 Remove all the expand buttons from main content panel for all titles */
            /* Section title. Exclude task labels generated by DITA-OT (EXM-37958 & EXM-38501).*/
            /* ".sectiontitle:not(.tasklabel)", *//* DOCS-419 Remove all the expand buttons from main content panel for all titles */
            /* Index terms groups */
