...
docker tag upgradediffs-page-builder artifactory.guidewire.com/doctools-docker-dev/upgradediffs-page-builder:$IMAGE_VERSION
docker push artifactory.guidewire.com/doctools-docker-dev/upgradediffs-page-builder:$IMAGE_VERSION
