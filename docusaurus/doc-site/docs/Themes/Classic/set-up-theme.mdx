...
import ThemeWarning from '../../_do-not-use-theme.mdx';
...
Make sure you follow [the steps on our Getting started page](../../intro.mdx).

## Install

import ThemeCodeBlock from '@site/src/components/InstallationCodeBlock.tsx';

<ThemeCodeBlock packageName="gw-theme-classic" />
...
- A log in/out button that checks user identity using the API available on
  docs.guidewire.com. ../../\_do-not-use-theme.mdx
