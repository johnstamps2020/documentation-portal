...
<RightWrong>
  <Right title="Polite">
    - Talk to other passengers about the weather - Thank the bus driver - Say
    "please" and "thank you"
  </Right>
  <Wrong title="Impolite">
    - Talk to the bus driver about the weather - Not thank the bus driver - Say
    "tell me what time it is" and "get that for me real quick, or else..."
  </Wrong>
</RightWrong>
```
