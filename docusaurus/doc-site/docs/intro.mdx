...
Node.js version 20.0 or above is required. Your current version of Node.js can
...
2. Go to your working directory (e.q. `website` in Docusaurus) and set Yarn to latest.
