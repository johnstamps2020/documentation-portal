...
Explore our [redirect service repository](https://stash.guidewire.com/projects/DOCTOOLS/repos/redirect-server/browse),
which contains all the necessary resources and code for implementing the redirect
service on your site. To get started, please follow the instructions outlined
in the ReadMe file. It provides step-by-step guidance on how to apply the redirect 
service to your website, ensuring a smooth transition for your visitors.
