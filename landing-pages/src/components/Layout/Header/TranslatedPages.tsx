...
export default function TranslatedPages() {
  ...
  const pages = [
    { label: 'Deutsch', url: '/l10n-new/de-DE' },
    { label: 'Español (España)', url: '/l10n-new/es-ES' },
    { label: 'Español', url: '/l10n-new/es-LA' },
    { label: 'Français', url: '/l10n-new/fr-FR' },
    { label: 'Italiano', url: '/l10n-new/it-IT' },
    { label: '日本語', url: '/l10n-new/ja-JP' },
    { label: 'Nederlands', url: '/l10n-new/nl-NL' },
    { label: 'Português', url: '/l10n-new/pt-BR' },
  ];
