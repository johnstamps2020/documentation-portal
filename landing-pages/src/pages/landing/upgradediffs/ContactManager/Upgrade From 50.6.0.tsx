  ...
  items: [
    {
      ...
      url: '/upgradediffs/ContactManager/Upgrade%20From%2050.6.0/Upgrade%20To%2050.8.0',
      videoIcon: false,
    },
    {
      label: 'Upgrade To 50.7.0',
      url: '/upgradediffs/ContactManager/Upgrade%20From%2050.6.0/Upgrade%20To%2050.7.0',
      videoIcon: false,
    },
  ],
  sidebar: {
