      ...
      items: [
        {
          ...
          docId: 'iscc202402ptBRapp',
        },
        {
          label: 'Notas de versão',
          docId: 'iscc202402ptBRreleasenotes',
        },
        {
          label: 'Guia de atualização',
          docId: 'iscc202402ptBRupdate',
        },
      ],
    },
    {
...
export const Route = createFileRoute('/l10n/pt-BR/cc')({
  component: Cc,
});
