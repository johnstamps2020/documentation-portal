        ...
        <Stack spacing={6}>
          ...
          <Stack spacing={2}>
            ...
            <Typography>
              ...
              depending on geographic location. To determine whether a specific
              offering is available in your geographic location, contact your
              Guidewire sales representative.
            </Typography>
            <Link
