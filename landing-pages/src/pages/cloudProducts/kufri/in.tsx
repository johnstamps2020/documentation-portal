    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          docId: 'in20242xcservicepconfigdraft',
        },
        {
          ...
          docId: 'in20242xcsalespconfigdraft',
        },
      ],
    },
    {
...
export const Route = createFileRoute('/cloudProducts/kufri/in')({
  component: LandingPage20242,
});

function LandingPage20242() {
