...
const pageConfig: ApplicationLayoutProps = {
  title: 'BillingCenter for Guidewire Cloud 2024.11',
  buttonProps: {
    label: 'Release notes',
...
export const Route = createFileRoute('/cloudProducts/laslenas/bc')({
