...
const pageConfig: ApplicationLayoutProps = {
  ...
  tabs: [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          docId: 'in20243xcservicepconfigdraft',
        },
        {
          ...
          docId: 'in20243xcsalespconfigdraft',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Automated Functional Testing (AFT) Framework',
          docId: 'inautomatedfunctionaltestingframework',
          description: (
            <>
              Set up automated functional testing (AFT) for InsuranceNow using
  ...
  selector: {
    selectedItemLabel: 'Las Leñas (2024.3)',
    items: allSelectors.s8f0ef4ce7f1a0e901c8b8c38ba2d3ca1,
    labelColor: 'black',
  },
};

export const Route = createFileRoute('/cloudProducts/laslenas/in')({
  component: LandingPage20243,
});

function LandingPage20243() {
